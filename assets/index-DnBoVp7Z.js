...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function pl(){return new Bt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xo(),fragmentShader:`
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function ml(){return new Bt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xo(),fragmentShader:`
...
`)}const Tl=new qe;function Cm(i){tt._getMatrix(Tl,tt.workingColorSpace,i);const e=`mat3( ${Tl.elements.map(t=>t.toFixed(4))} )`;switch(tt.getTransfer(i)){case hs:return[e,"LinearTransferOETF"];case st:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function bl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`
...
}`;function lg(i,e,t){let n=new fo;const r=new Be,s=new Be,a=new lt,o=new Th({depthPacking:_u}),l=new bh,c={},u=t.maxTextureSize,h={[Nn]:zt,[zt]:Nn,[Pn]:Pn},f=new Bt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Be},radius:{value:4}},vertexShader:ag,fragmentShader:og}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new Wt;_.setAttribute("position",new an(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ie(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Yl;let d=this.type;this.render=function(A,R,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const y=i.getRenderTarget(),x=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),z=i.state;z.setBlending(Dn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const B=d!==Cn&&this.type===Cn,q=d===Cn&&this.type!==Cn;for(let Z=0,Y=A.length;Z<Y;Z++){const re=A[Z],K=re.shadow;if(K===void 0){console.warn("THREE.WebGLShadowMap:",re,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;r.copy(K.mapSize);const ae=K.getFrameExtents();if(r.multiply(ae),s.copy(K.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ae.x),r.x=s.x*ae.x,K.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ae.y),r.y=s.y*ae.y,K.mapSize.y=s.y)),K.map===null||B===!0||q===!0){const Pe=this.type!==Cn?{minFilter:Jt,magFilter:Jt}:{};K.map!==null&&K.map.dispose(),K.map=new dn(r.x,r.y,Pe),K.map.texture.name=re.name+".shadowMap",K.camera.updateProjectionMatrix()}i.setRenderTarget(K.map),i.clear();const he=K.getViewportCount();for(let Pe=0;Pe<he;Pe++){const Ve=K.getViewport(Pe);a.set(s.x*Ve.x,s.y*Ve.y,s.x*Ve.z,s.y*Ve.w),z.viewport(a),K.updateMatrices(re,Pe),n=K.getFrustum(),M(R,P,K.camera,re,this.type)}K.isPointLightShadow!==!0&&this.type===Cn&&w(K,P),K.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(y,x,C)};function w(A,R){const P=e.update(v);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new dn(r.x,r.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(R,null,P,f,v,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(R,null,P,p,v,null)}function E(A,R,P,y){let x=null;const C=P.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(C!==void 0)x=C;else if(x=P.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const z=x.uuid,B=R.uuid;let q=c[z];q===void 0&&(q={},c[z]=q);let Z=q[B];Z===void 0&&(Z=x.clone(),q[B]=Z,R.addEventListener("dispose",D)),x=Z}if(x.visible=R.visible,x.wireframe=R.wireframe,y===Cn?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:h[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,P.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const z=i.properties.get(x);z.light=P}return x}function M(A,R,P,y,x){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&x===Cn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,A.matrixWorld);const B=e.update(A),q=A.material;if(Array.isArray(q)){const Z=B.groups;for(let Y=0,re=Z.length;Y<re;Y++){const K=Z[Y],ae=q[K.materialIndex];if(ae&&ae.visible){const he=E(A,ae,y,x);A.onBeforeShadow(i,A,R,P,B,he,K),i.renderBufferDirect(P,null,B,he,A,K),A.onAfterShadow(i,A,R,P,B,he,K)}}}else if(q.visible){const Z=E(A,q,y,x);A.onBeforeShadow(i,A,R,P,B,Z,null),i.renderBufferDirect(P,null,B,Z,A,null),A.onAfterShadow(i,A,R,P,B,Z,null)}}const z=A.children;for(let B=0,q=z.length;B<q;B++)M(z[B],R,P,y,x)}function D(A){A.target.removeEventListener("dispose",D);for(const P in c){const y=c[P],x=A.target.uuid;x in y&&(y[x].dispose(),delete y[x])}}}const cg={[aa]:oa,[la]:ha,[ca]:fa,[ki]:ua,[oa]:aa,[ha]:la,[fa]:ca,[ua]:ki};function ug(i,e){function t(){let I=!1;const ue=new lt;let te=null;const ge=new lt(0,0,0,0);return{setMask:function(ie){te!==ie&&!I&&(i.colorMask(ie,ie,ie,ie),te=ie)},setLocked:function(ie){I=ie},setClear:function(ie,ee,Ce,ke,rt){rt===!0&&(ie*=ke,ee*=ke,Ce*=ke),ue.set(ie,ee,Ce,ke),ge.equals(ue)===!1&&(i.clearColor(ie,ee,Ce,ke),ge.copy(ue))},reset:function(){I=!1,te=null,ge.set(-1,0,0,0)}}}function n(){let I=!1,ue=!1,te=null,ge=null,ie=null;return{setReversed:function(ee){if(ue!==ee){const Ce=e.get("EXT_clip_control");ee?Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.ZERO_TO_ONE_EXT):Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.NEGATIVE_ONE_TO_ONE_EXT),ue=ee;const ke=ie;ie=null,this.setClear(ke)}},getReversed:function(){return ue},setTest:function(ee){ee?pe(i.DEPTH_TEST):De(i.DEPTH_TEST)},setMask:function(ee){te!==ee&&!I&&(i.depthMask(ee),te=ee)},setFunc:function(ee){if(ue&&(ee=cg[ee]),ge!==ee){switch(ee){case aa:i.depthFunc(i.NEVER);break;case oa:i.depthFunc(i.ALWAYS);break;case la:i.depthFunc(i.LESS);break;case ki:i.depthFunc(i.LEQUAL);break;case ca:i.depthFunc(i.EQUAL);break;case ua:i.depthFunc(i.GEQUAL);break;case ha:i.depthFunc(i.GREATER);break;case fa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ge=ee}},setLocked:function(ee){I=ee},setClear:function(ee){ie!==ee&&(ue&&(ee=1-ee),i.clearDepth(ee),ie=ee)},reset:function(){I=!1,te=null,ge=null,ie=null,ue=!1}}}function r(){let I=!1,ue=null,te=null,ge=null,ie=null,ee=null,Ce=null,ke=null,rt=null;return{setTest:function(nt){I||(nt?pe(i.STENCIL_TEST):De(i.STENCIL_TEST))},setMask:function(nt){ue!==nt&&!I&&(i.stencilMask(nt),ue=nt)},setFunc:function(nt,Dt,Qt){(te!==nt||ge!==Dt||ie!==Qt)&&(i.stencilFunc(nt,Dt,Qt),te=nt,ge=Dt,ie=Qt)},setOp:function(nt,Dt,Qt){(ee!==nt||Ce!==Dt||ke!==Qt)&&(i.stencilOp(nt,Dt,Qt),ee=nt,Ce=Dt,ke=Qt)},setLocked:function(nt){I=nt},setClear:function(nt){rt!==nt&&(i.clearStencil(nt),rt=nt)},reset:function(){I=!1,ue=null,te=null,ge=null,ie=null,ee=null,Ce=null,ke=null,rt=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],_=null,v=!1,m=null,d=null,w=null,E=null,M=null,D=null,A=null,R=new We(0,0,0),P=0,y=!1,x=null,C=null,z=null,B=null,q=null;const Z=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,re=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(re=parseFloat(/^WebGL (\d)/.exec(K)[1]),Y=re>=1):K.indexOf("OpenGL ES")!==-1&&(re=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),Y=re>=2);let ae=null,he={};const Pe=i.getParameter(i.SCISSOR_BOX),Ve=i.getParameter(i.VIEWPORT),Ke=new lt().fromArray(Pe),j=new lt().fromArray(Ve);function ce(I,ue,te,ge){const ie=new Uint8Array(4),ee=i.createTexture();i.bindTexture(I,ee),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ce=0;Ce<te;Ce++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(ue,0,i.RGBA,1,1,ge,0,i.RGBA,i.UNSIGNED_BYTE,ie):i.texImage2D(ue+Ce,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ie);return ee}const Se={};Se[i.TEXTURE_2D]=ce(i.TEXTURE_2D,i.TEXTURE_2D,1),Se[i.TEXTURE_CUBE_MAP]=ce(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Se[i.TEXTURE_2D_ARRAY]=ce(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Se[i.TEXTURE_3D]=ce(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),pe(i.DEPTH_TEST),a.setFunc(ki),ve(!1),me(Co),pe(i.CULL_FACE),T(Dn);function pe(I){u[I]!==!0&&(i.enable(I),u[I]=!0)}function De(I){u[I]!==!1&&(i.disable(I),u[I]=!1)}function je(I,ue){return h[I]!==ue?(i.bindFramebuffer(I,ue),h[I]=ue,I===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ue),I===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ue),!0):!1}function G(I,ue){let te=p,ge=!1;if(I){te=f.get(ue),te===void 0&&(te=[],f.set(ue,te));const ie=I.textures;if(te.length!==ie.length||te[0]!==i.COLOR_ATTACHMENT0){for(let ee=0,Ce=ie.length;ee<Ce;ee++)te[ee]=i.COLOR_ATTACHMENT0+ee;te.length=ie.length,ge=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,ge=!0);ge&&i.drawBuffers(te)}function ne(I){return _!==I?(i.useProgram(I),_=I,!0):!1}const H={[ri]:i.FUNC_ADD,[jc]:i.FUNC_SUBTRACT,[Zc]:i.FUNC_REVERSE_SUBTRACT};H[Jc]=i.MIN,H[Qc]=i.MAX;const W={[eu]:i.ZERO,[tu]:i.ONE,[nu]:i.SRC_COLOR,[ra]:i.SRC_ALPHA,[lu]:i.SRC_ALPHA_SATURATE,[au]:i.DST_COLOR,[ru]:i.DST_ALPHA,[iu]:i.ONE_MINUS_SRC_COLOR,[sa]:i.ONE_MINUS_SRC_ALPHA,[ou]:i.ONE_MINUS_DST_COLOR,[su]:i.ONE_MINUS_DST_ALPHA,[cu]:i.CONSTANT_COLOR,[uu]:i.ONE_MINUS_CONSTANT_COLOR,[hu]:i.CONSTANT_ALPHA,[fu]:i.ONE_MINUS_CONSTANT_ALPHA};function T(I,ue,te,ge,ie,ee,Ce,ke,rt,nt){if(I===Dn){v===!0&&(De(i.BLEND),v=!1);return}if(v===!1&&(pe(i.BLEND),v=!0),I!==Kc){if(I!==m||nt!==y){if((d!==ri||M!==ri)&&(i.blendEquation(i.FUNC_ADD),d=ri,M=ri),nt)switch(I){case Oi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case li:i.blendFunc(i.ONE,i.ONE);break;case Po:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Lo:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case Oi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case li:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Po:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Lo:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}w=null,E=null,D=null,A=null,R.set(0,0,0),P=0,m=I,y=nt}return}ie=ie||ue,ee=ee||te,Ce=Ce||ge,(ue!==d||ie!==M)&&(i.blendEquationSeparate(H[ue],H[ie]),d=ue,M=ie),(te!==w||ge!==E||ee!==D||Ce!==A)&&(i.blendFuncSeparate(W[te],W[ge],W[ee],W[Ce]),w=te,E=ge,D=ee,A=Ce),(ke.equals(R)===!1||rt!==P)&&(i.blendColor(ke.r,ke.g,ke.b,rt),R.copy(ke),P=rt),m=I,y=!1}function Re(I,ue){I.side===Pn?De(i.CULL_FACE):pe(i.CULL_FACE);let te=I.side===zt;ue&&(te=!te),ve(te),I.blending===Oi&&I.transparent===!1?T(Dn):T(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const ge=I.stencilWrite;o.setTest(ge),ge&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Oe(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?pe(i.SAMPLE_ALPHA_TO_COVERAGE):De(i.SAMPLE_ALPHA_TO_COVERAGE)}function ve(I){x!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),x=I)}function me(I){I!==qc?(pe(i.CULL_FACE),I!==C&&(I===Co?i.cullFace(i.BACK):I===Yc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):De(i.CULL_FACE),C=I}function Q(I){I!==z&&(Y&&i.lineWidth(I),z=I)}function Oe(I,ue,te){I?(pe(i.POLYGON_OFFSET_FILL),(B!==ue||q!==te)&&(i.polygonOffset(ue,te),B=ue,q=te)):De(i.POLYGON_OFFSET_FILL)}function we(I){I?pe(i.SCISSOR_TEST):De(i.SCISSOR_TEST)}function Te(I){I===void 0&&(I=i.TEXTURE0+Z-1),ae!==I&&(i.activeTexture(I),ae=I)}function Qe(I,ue,te){te===void 0&&(ae===null?te=i.TEXTURE0+Z-1:te=ae);let ge=he[te];ge===void 0&&(ge={type:void 0,texture:void 0},he[te]=ge),(ge.type!==I||ge.texture!==ue)&&(ae!==te&&(i.activeTexture(te),ae=te),i.bindTexture(I,ue||Se[I]),ge.type=I,ge.texture=ue)}function b(){const I=he[ae];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function O(){try{i.texSubImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function $(){try{i.texSubImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function _e(){try{i.compressedTexSubImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function le(){try{i.texStorage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function de(){try{i.texStorage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function be(){try{i.texImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function J(){try{i.texImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Me(I){Ke.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),Ke.copy(I))}function fe(I){j.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),j.copy(I))}function Ee(I,ue){let te=c.get(ue);te===void 0&&(te=new WeakMap,c.set(ue,te));let ge=te.get(I);ge===void 0&&(ge=i.getUniformBlockIndex(ue,I.name),te.set(I,ge))}function oe(I,ue){const ge=c.get(ue).get(I);l.get(ue)!==ge&&(i.uniformBlockBinding(ue,ge,I.__bindingPointIndex),l.set(ue,ge))}function Ue(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},ae=null,he={},h={},f=new WeakMap,p=[],_=null,v=!1,m=null,d=null,w=null,E=null,M=null,D=null,A=null,R=new We(0,0,0),P=0,y=!1,x=null,C=null,z=null,B=null,q=null,Ke.set(0,0,i.canvas.width,i.canvas.height),j.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:pe,disable:De,bindFramebuffer:je,drawBuffers:G,useProgram:ne,setBlending:T,setMaterial:Re,setFlipSided:ve,setCullFace:me,setLineWidth:Q,setPolygonOffset:Oe,setScissorTest:we,activeTexture:Te,bindTexture:Qe,unbindTexture:b,compressedTexImage2D:g,compressedTexImage3D:L,texImage2D:be,texImage3D:J,updateUBOMapping:Ee,uniformBlockBinding:oe,texStorage2D:le,texStorage3D:de,texSubImage2D:O,texSubImage3D:$,compressedTexSubImage2D:k,compressedTexSubImage3D:_e,scissor:Me,viewport:fe,reset:Ue}}function hg(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Be,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(b,g){return p?new OffscreenCanvas(b,g):Mr("canvas")}function v(b,g,L){let O=1;const $=Qe(b);if(($.width>L||$.height>L)&&(O=L/Math.max($.width,$.height)),O<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const k=Math.floor(O*$.width),_e=Math.floor(O*$.height);h===void 0&&(h=_(k,_e));const le=g?_(k,_e):h;return le.width=k,le.height=_e,le.getContext("2d").drawImage(b,0,0,k,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+k+"x"+_e+")."),le}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),b;return b}function m(b){return b.generateMipmaps}function d(b){i.generateMipmap(b)}function w(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(b,g,L,O,$=!1){if(b!==null){if(i[b]!==void 0)return i[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let k=g;if(g===i.RED&&(L===i.FLOAT&&(k=i.R32F),L===i.HALF_FLOAT&&(k=i.R16F),L===i.UNSIGNED_BYTE&&(k=i.R8)),g===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.R8UI),L===i.UNSIGNED_SHORT&&(k=i.R16UI),L===i.UNSIGNED_INT&&(k=i.R32UI),L===i.BYTE&&(k=i.R8I),L===i.SHORT&&(k=i.R16I),L===i.INT&&(k=i.R32I)),g===i.RG&&(L===i.FLOAT&&(k=i.RG32F),L===i.HALF_FLOAT&&(k=i.RG16F),L===i.UNSIGNED_BYTE&&(k=i.RG8)),g===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.RG8UI),L===i.UNSIGNED_SHORT&&(k=i.RG16UI),L===i.UNSIGNED_INT&&(k=i.RG32UI),L===i.BYTE&&(k=i.RG8I),L===i.SHORT&&(k=i.RG16I),L===i.INT&&(k=i.RG32I)),g===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.RGB8UI),L===i.UNSIGNED_SHORT&&(k=i.RGB16UI),L===i.UNSIGNED_INT&&(k=i.RGB32UI),L===i.BYTE&&(k=i.RGB8I),L===i.SHORT&&(k=i.RGB16I),L===i.INT&&(k=i.RGB32I)),g===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(k=i.RGBA16UI),L===i.UNSIGNED_INT&&(k=i.RGBA32UI),L===i.BYTE&&(k=i.RGBA8I),L===i.SHORT&&(k=i.RGBA16I),L===i.INT&&(k=i.RGBA32I)),g===i.RGB&&L===i.UNSIGNED_INT_5_9_9_9_REV&&(k=i.RGB9_E5),g===i.RGBA){const _e=$?hs:tt.getTransfer(O);L===i.FLOAT&&(k=i.RGBA32F),L===i.HALF_FLOAT&&(k=i.RGBA16F),L===i.UNSIGNED_BYTE&&(k=_e===st?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(k=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(k=i.RGB5_A1)}return(k===i.R16F||k===i.R32F||k===i.RG16F||k===i.RG32F||k===i.RGBA16F||k===i.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function M(b,g){let L;return b?g===null||g===ui||g===_r?L=i.DEPTH24_STENCIL8:g===Mn?L=i.DEPTH32F_STENCIL8:g===gr&&(L=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===ui||g===_r?L=i.DEPTH_COMPONENT24:g===Mn?L=i.DEPTH_COMPONENT32F:g===gr&&(L=i.DEPTH_COMPONENT16),L}function D(b,g){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==Jt&&b.minFilter!==xn?Math.log2(Math.max(g.width,g.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?g.mipmaps.length:1}function A(b){const g=b.target;g.removeEventListener("dispose",A),P(g),g.isVideoTexture&&u.delete(g)}function R(b){const g=b.target;g.removeEventListener("dispose",R),x(g)}function P(b){const g=n.get(b);if(g.__webglInit===void 0)return;const L=b.source,O=f.get(L);if(O){const $=O[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&y(b),Object.keys(O).length===0&&f.delete(L)}n.remove(b)}function y(b){const g=n.get(b);i.deleteTexture(g.__webglTexture);const L=b.source,O=f.get(L);delete O[g.__cacheKey],a.memory.textures--}function x(b){const g=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let O=0;O<6;O++){if(Array.isArray(g.__webglFramebuffer[O]))for(let $=0;$<g.__webglFramebuffer[O].length;$++)i.deleteFramebuffer(g.__webglFramebuffer[O][$]);else i.deleteFramebuffer(g.__webglFramebuffer[O]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[O])}else{if(Array.isArray(g.__webglFramebuffer))for(let O=0;O<g.__webglFramebuffer.length;O++)i.deleteFramebuffer(g.__webglFramebuffer[O]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let O=0;O<g.__webglColorRenderbuffer.length;O++)g.__webglColorRenderbuffer[O]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[O]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const L=b.textures;for(let O=0,$=L.length;O<$;O++){const k=n.get(L[O]);k.__webglTexture&&(i.deleteTexture(k.__webglTexture),a.memory.textures--),n.remove(L[O])}n.remove(b)}let C=0;function z(){C=0}function B(){const b=C;return b>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),C+=1,b}function q(b){const g=[];return g.push(b.wrapS),g.push(b.wrapT),g.push(b.wrapR||0),g.push(b.magFilter),g.push(b.minFilter),g.push(b.anisotropy),g.push(b.internalFormat),g.push(b.format),g.push(b.type),g.push(b.generateMipmaps),g.push(b.premultiplyAlpha),g.push(b.flipY),g.push(b.unpackAlignment),g.push(b.colorSpace),g.join()}function Z(b,g){const L=n.get(b);if(b.isVideoTexture&&we(b),b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){const O=b.image;if(O===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(O.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Se(L,b,g);return}}t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+g)}function Y(b,g){const L=n.get(b);if(b.version>0&&L.__version!==b.version){Se(L,b,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+g)}function re(b,g){const L=n.get(b);if(b.version>0&&L.__version!==b.version){Se(L,b,g);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+g)}function K(b,g){const L=n.get(b);if(b.version>0&&L.__version!==b.version){pe(L,b,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+g)}const ae={[Hi]:i.REPEAT,[Xn]:i.CLAMP_TO_EDGE,[ma]:i.MIRRORED_REPEAT},he={[Jt]:i.NEAREST,[mu]:i.NEAREST_MIPMAP_NEAREST,[br]:i.NEAREST_MIPMAP_LINEAR,[xn]:i.LINEAR,[Ms]:i.LINEAR_MIPMAP_NEAREST,[oi]:i.LINEAR_MIPMAP_LINEAR},Pe={[xu]:i.NEVER,[bu]:i.ALWAYS,[Mu]:i.LESS,[uc]:i.LEQUAL,[Su]:i.EQUAL,[Tu]:i.GEQUAL,[Eu]:i.GREATER,[yu]:i.NOTEQUAL};function Ve(b,g){if(g.type===Mn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===xn||g.magFilter===Ms||g.magFilter===br||g.magFilter===oi||g.minFilter===xn||g.minFilter===Ms||g.minFilter===br||g.minFilter===oi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,ae[g.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,ae[g.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,ae[g.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,he[g.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,he[g.minFilter]),g.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,Pe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Jt||g.minFilter!==br&&g.minFilter!==oi||g.type===Mn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ke(b,g){let L=!1;b.__webglInit===void 0&&(b.__webglInit=!0,g.addEventListener("dispose",A));const O=g.source;let $=f.get(O);$===void 0&&($={},f.set(O,$));const k=q(g);if(k!==b.__cacheKey){$[k]===void 0&&($[k]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,L=!0),$[k].usedTimes++;const _e=$[b.__cacheKey];_e!==void 0&&($[b.__cacheKey].usedTimes--,_e.usedTimes===0&&y(g)),b.__cacheKey=k,b.__webglTexture=$[k].texture}return L}function j(b,g,L){return Math.floor(Math.floor(b/L)/g)}function ce(b,g,L,O){const k=b.updateRanges;if(k.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,L,O,g.data);else{k.sort((J,Me)=>J.start-Me.start);let _e=0;for(let J=1;J<k.length;J++){const Me=k[_e],fe=k[J],Ee=Me.start+Me.count,oe=j(fe.start,g.width,4),Ue=j(Me.start,g.width,4);fe.start<=Ee+1&&oe===Ue&&j(fe.start+fe.count-1,g.width,4)===oe?Me.count=Math.max(Me.count,fe.start+fe.count-Me.start):(++_e,k[_e]=fe)}k.length=_e+1;const le=i.getParameter(i.UNPACK_ROW_LENGTH),de=i.getParameter(i.UNPACK_SKIP_PIXELS),be=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let J=0,Me=k.length;J<Me;J++){const fe=k[J],Ee=Math.floor(fe.start/4),oe=Math.ceil(fe.count/4),Ue=Ee%g.width,I=Math.floor(Ee/g.width),ue=oe,te=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ue),i.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Ue,I,ue,te,L,O,g.data)}b.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,le),i.pixelStorei(i.UNPACK_SKIP_PIXELS,de),i.pixelStorei(i.UNPACK_SKIP_ROWS,be)}}function Se(b,g,L){let O=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(O=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(O=i.TEXTURE_3D);const $=Ke(b,g),k=g.source;t.bindTexture(O,b.__webglTexture,i.TEXTURE0+L);const _e=n.get(k);if(k.version!==_e.__version||$===!0){t.activeTexture(i.TEXTURE0+L);const le=tt.getPrimaries(tt.workingColorSpace),de=g.colorSpace===Hn?null:tt.getPrimaries(g.colorSpace),be=g.colorSpace===Hn||le===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);let J=v(g.image,!1,r.maxTextureSize);J=Te(g,J);const Me=s.convert(g.format,g.colorSpace),fe=s.convert(g.type);let Ee=E(g.internalFormat,Me,fe,g.colorSpace,g.isVideoTexture);Ve(O,g);let oe;const Ue=g.mipmaps,I=g.isVideoTexture!==!0,ue=_e.__version===void 0||$===!0,te=k.dataReady,ge=D(g,J);if(g.isDepthTexture)Ee=M(g.format===xr,g.type),ue&&(I?t.texStorage2D(i.TEXTURE_2D,1,Ee,J.width,J.height):t.texImage2D(i.TEXTURE_2D,0,Ee,J.width,J.height,0,Me,fe,null));else if(g.isDataTexture)if(Ue.length>0){I&&ue&&t.texStorage2D(i.TEXTURE_2D,ge,Ee,Ue[0].width,Ue[0].height);for(let ie=0,ee=Ue.length;ie<ee;ie++)oe=Ue[ie],I?te&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,oe.width,oe.height,Me,fe,oe.data):t.texImage2D(i.TEXTURE_2D,ie,Ee,oe.width,oe.height,0,Me,fe,oe.data);g.generateMipmaps=!1}else I?(ue&&t.texStorage2D(i.TEXTURE_2D,ge,Ee,J.width,J.height),te&&ce(g,J,Me,fe)):t.texImage2D(i.TEXTURE_2D,0,Ee,J.width,J.height,0,Me,fe,J.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){I&&ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,Ee,Ue[0].width,Ue[0].height,J.depth);for(let ie=0,ee=Ue.length;ie<ee;ie++)if(oe=Ue[ie],g.format!==fn)if(Me!==null)if(I){if(te)if(g.layerUpdates.size>0){const Ce=cl(oe.width,oe.height,g.format,g.type);for(const ke of g.layerUpdates){const rt=oe.data.subarray(ke*Ce/oe.data.BYTES_PER_ELEMENT,(ke+1)*Ce/oe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,ke,oe.width,oe.height,1,Me,rt)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,0,oe.width,oe.height,J.depth,Me,oe.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ie,Ee,oe.width,oe.height,J.depth,0,oe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?te&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,0,oe.width,oe.height,J.depth,Me,fe,oe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ie,Ee,oe.width,oe.height,J.depth,0,Me,fe,oe.data)}else{I&&ue&&t.texStorage2D(i.TEXTURE_2D,ge,Ee,Ue[0].width,Ue[0].height);for(let ie=0,ee=Ue.length;ie<ee;ie++)oe=Ue[ie],g.format!==fn?Me!==null?I?te&&t.compressedTexSubImage2D(i.TEXTURE_2D,ie,0,0,oe.width,oe.height,Me,oe.data):t.compressedTexImage2D(i.TEXTURE_2D,ie,Ee,oe.width,oe.height,0,oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?te&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,oe.width,oe.height,Me,fe,oe.data):t.texImage2D(i.TEXTURE_2D,ie,Ee,oe.width,oe.height,0,Me,fe,oe.data)}else if(g.isDataArrayTexture)if(I){if(ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,Ee,J.width,J.height,J.depth),te)if(g.layerUpdates.size>0){const ie=cl(J.width,J.height,g.format,g.type);for(const ee of g.layerUpdates){const Ce=J.data.subarray(ee*ie/J.data.BYTES_PER_ELEMENT,(ee+1)*ie/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ee,J.width,J.height,1,Me,fe,Ce)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,Me,fe,J.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ee,J.width,J.height,J.depth,0,Me,fe,J.data);else if(g.isData3DTexture)I?(ue&&t.texStorage3D(i.TEXTURE_3D,ge,Ee,J.width,J.height,J.depth),te&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,Me,fe,J.data)):t.texImage3D(i.TEXTURE_3D,0,Ee,J.width,J.height,J.depth,0,Me,fe,J.data);else if(g.isFramebufferTexture){if(ue)if(I)t.texStorage2D(i.TEXTURE_2D,ge,Ee,J.width,J.height);else{let ie=J.width,ee=J.height;for(let Ce=0;Ce<ge;Ce++)t.texImage2D(i.TEXTURE_2D,Ce,Ee,ie,ee,0,Me,fe,null),ie>>=1,ee>>=1}}else if(Ue.length>0){if(I&&ue){const ie=Qe(Ue[0]);t.texStorage2D(i.TEXTURE_2D,ge,Ee,ie.width,ie.height)}for(let ie=0,ee=Ue.length;ie<ee;ie++)oe=Ue[ie],I?te&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,Me,fe,oe):t.texImage2D(i.TEXTURE_2D,ie,Ee,Me,fe,oe);g.generateMipmaps=!1}else if(I){if(ue){const ie=Qe(J);t.texStorage2D(i.TEXTURE_2D,ge,Ee,ie.width,ie.height)}te&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Me,fe,J)}else t.texImage2D(i.TEXTURE_2D,0,Ee,Me,fe,J);m(g)&&d(O),_e.__version=k.version,g.onUpdate&&g.onUpdate(g)}b.__version=g.version}function pe(b,g,L){if(g.image.length!==6)return;const O=Ke(b,g),$=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+L);const k=n.get($);if($.version!==k.__version||O===!0){t.activeTexture(i.TEXTURE0+L);const _e=tt.getPrimaries(tt.workingColorSpace),le=g.colorSpace===Hn?null:tt.getPrimaries(g.colorSpace),de=g.colorSpace===Hn||_e===le?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const be=g.isCompressedTexture||g.image[0].isCompressedTexture,J=g.image[0]&&g.image[0].isDataTexture,Me=[];for(let ee=0;ee<6;ee++)!be&&!J?Me[ee]=v(g.image[ee],!0,r.maxCubemapSize):Me[ee]=J?g.image[ee].image:g.image[ee],Me[ee]=Te(g,Me[ee]);const fe=Me[0],Ee=s.convert(g.format,g.colorSpace),oe=s.convert(g.type),Ue=E(g.internalFormat,Ee,oe,g.colorSpace),I=g.isVideoTexture!==!0,ue=k.__version===void 0||O===!0,te=$.dataReady;let ge=D(g,fe);Ve(i.TEXTURE_CUBE_MAP,g);let ie;if(be){I&&ue&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Ue,fe.width,fe.height);for(let ee=0;ee<6;ee++){ie=Me[ee].mipmaps;for(let Ce=0;Ce<ie.length;Ce++){const ke=ie[Ce];g.format!==fn?Ee!==null?I?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,0,0,ke.width,ke.height,Ee,ke.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,Ue,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,0,0,ke.width,ke.height,Ee,oe,ke.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,Ue,ke.width,ke.height,0,Ee,oe,ke.data)}}}else{if(ie=g.mipmaps,I&&ue){ie.length>0&&ge++;const ee=Qe(Me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Ue,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(J){I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Me[ee].width,Me[ee].height,Ee,oe,Me[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ue,Me[ee].width,Me[ee].height,0,Ee,oe,Me[ee].data);for(let Ce=0;Ce<ie.length;Ce++){const rt=ie[Ce].image[ee].image;I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,0,0,rt.width,rt.height,Ee,oe,rt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,Ue,rt.width,rt.height,0,Ee,oe,rt.data)}}else{I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ee,oe,Me[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ue,Ee,oe,Me[ee]);for(let Ce=0;Ce<ie.length;Ce++){const ke=ie[Ce];I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,0,0,Ee,oe,ke.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,Ue,Ee,oe,ke.image[ee])}}}m(g)&&d(i.TEXTURE_CUBE_MAP),k.__version=$.version,g.onUpdate&&g.onUpdate(g)}b.__version=g.version}function De(b,g,L,O,$,k){const _e=s.convert(L.format,L.colorSpace),le=s.convert(L.type),de=E(L.internalFormat,_e,le,L.colorSpace),be=n.get(g),J=n.get(L);if(J.__renderTarget=g,!be.__hasExternalTextures){const Me=Math.max(1,g.width>>k),fe=Math.max(1,g.height>>k);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,k,de,Me,fe,g.depth,0,_e,le,null):t.texImage2D($,k,de,Me,fe,0,_e,le,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),Oe(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,O,$,J.__webglTexture,0,Q(g)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,O,$,J.__webglTexture,k),t.bindFramebuffer(i.FRAMEBUFFER,null)}function je(b,g,L){if(i.bindRenderbuffer(i.RENDERBUFFER,b),g.depthBuffer){const O=g.depthTexture,$=O&&O.isDepthTexture?O.type:null,k=M(g.stencilBuffer,$),_e=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,le=Q(g);Oe(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,le,k,g.width,g.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,le,k,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,k,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,_e,i.RENDERBUFFER,b)}else{const O=g.textures;for(let $=0;$<O.length;$++){const k=O[$],_e=s.convert(k.format,k.colorSpace),le=s.convert(k.type),de=E(k.internalFormat,_e,le,k.colorSpace),be=Q(g);L&&Oe(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,be,de,g.width,g.height):Oe(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,be,de,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,de,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function G(b,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const O=n.get(g.depthTexture);O.__renderTarget=g,(!O.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),Z(g.depthTexture,0);const $=O.__webglTexture,k=Q(g);if(g.depthTexture.format===vr)Oe(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0,k):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0);else if(g.depthTexture.format===xr)Oe(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0,k):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function ne(b){const g=n.get(b),L=b.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==b.depthTexture){const O=b.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),O){const $=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,O.removeEventListener("dispose",$)};O.addEventListener("dispose",$),g.__depthDisposeCallback=$}g.__boundDepthTexture=O}if(b.depthTexture&&!g.__autoAllocateDepthBuffer){if(L)throw new Error("target.depthTexture not supported in Cube render targets");const O=b.texture.mipmaps;O&&O.length>0?G(g.__webglFramebuffer[0],b):G(g.__webglFramebuffer,b)}else if(L){g.__webglDepthbuffer=[];for(let O=0;O<6;O++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[O]),g.__webglDepthbuffer[O]===void 0)g.__webglDepthbuffer[O]=i.createRenderbuffer(),je(g.__webglDepthbuffer[O],b,!1);else{const $=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,k=g.__webglDepthbuffer[O];i.bindRenderbuffer(i.RENDERBUFFER,k),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,k)}}else{const O=b.texture.mipmaps;if(O&&O.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),je(g.__webglDepthbuffer,b,!1);else{const $=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,k=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,k),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,k)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function H(b,g,L){const O=n.get(b);g!==void 0&&De(O.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&ne(b)}function W(b){const g=b.texture,L=n.get(b),O=n.get(g);b.addEventListener("dispose",R);const $=b.textures,k=b.isWebGLCubeRenderTarget===!0,_e=$.length>1;if(_e||(O.__webglTexture===void 0&&(O.__webglTexture=i.createTexture()),O.__version=g.version,a.memory.textures++),k){L.__webglFramebuffer=[];for(let le=0;le<6;le++)if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer[le]=[];for(let de=0;de<g.mipmaps.length;de++)L.__webglFramebuffer[le][de]=i.createFramebuffer()}else L.__webglFramebuffer[le]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer=[];for(let le=0;le<g.mipmaps.length;le++)L.__webglFramebuffer[le]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(_e)for(let le=0,de=$.length;le<de;le++){const be=n.get($[le]);be.__webglTexture===void 0&&(be.__webglTexture=i.createTexture(),a.memory.textures++)}if(b.samples>0&&Oe(b)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let le=0;le<$.length;le++){const de=$[le];L.__webglColorRenderbuffer[le]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[le]);const be=s.convert(de.format,de.colorSpace),J=s.convert(de.type),Me=E(de.internalFormat,be,J,de.colorSpace,b.isXRRenderTarget===!0),fe=Q(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,fe,Me,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,L.__webglColorRenderbuffer[le])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),je(L.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(k){t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture),Ve(i.TEXTURE_CUBE_MAP,g);for(let le=0;le<6;le++)if(g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)De(L.__webglFramebuffer[le][de],b,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+le,de);else De(L.__webglFramebuffer[le],b,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);m(g)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let le=0,de=$.length;le<de;le++){const be=$[le],J=n.get(be);t.bindTexture(i.TEXTURE_2D,J.__webglTexture),Ve(i.TEXTURE_2D,be),De(L.__webglFramebuffer,b,be,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,0),m(be)&&d(i.TEXTURE_2D)}t.unbindTexture()}else{let le=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(le=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(le,O.__webglTexture),Ve(le,g),g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)De(L.__webglFramebuffer[de],b,g,i.COLOR_ATTACHMENT0,le,de);else De(L.__webglFramebuffer,b,g,i.COLOR_ATTACHMENT0,le,0);m(g)&&d(le),t.unbindTexture()}b.depthBuffer&&ne(b)}function T(b){const g=b.textures;for(let L=0,O=g.length;L<O;L++){const $=g[L];if(m($)){const k=w(b),_e=n.get($).__webglTexture;t.bindTexture(k,_e),d(k),t.unbindTexture()}}}const Re=[],ve=[];function me(b){if(b.samples>0){if(Oe(b)===!1){const g=b.textures,L=b.width,O=b.height;let $=i.COLOR_BUFFER_BIT;const k=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,_e=n.get(b),le=g.length>1;if(le)for(let be=0;be<g.length;be++)t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);const de=b.texture.mipmaps;de&&de.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let be=0;be<g.length;be++){if(b.resolveDepthBuffer&&(b.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),le){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,_e.__webglColorRenderbuffer[be]);const J=n.get(g[be]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,J,0)}i.blitFramebuffer(0,0,L,O,0,0,L,O,$,i.NEAREST),l===!0&&(Re.length=0,ve.length=0,Re.push(i.COLOR_ATTACHMENT0+be),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Re.push(k),ve.push(k),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ve)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Re))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),le)for(let be=0;be<g.length;be++){t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,_e.__webglColorRenderbuffer[be]);const J=n.get(g[be]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,J,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const g=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Q(b){return Math.min(r.maxSamples,b.samples)}function Oe(b){const g=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function we(b){const g=a.render.frame;u.get(b)!==g&&(u.set(b,g),b.update())}function Te(b,g){const L=b.colorSpace,O=b.format,$=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||L!==Wi&&L!==Hn&&(tt.getTransfer(L)===st?(O!==fn||$!==En)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",L)),g}function Qe(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=z,this.setTexture2D=Z,this.setTexture2DArray=Y,this.setTexture3D=re,this.setTextureCube=K,this.rebindTextures=H,this.setupRenderTarget=W,this.updateRenderTargetMipmap=T,this.updateMultisampleRenderTarget=me,this.setupDepthRenderbuffer=ne,this.setupFrameBufferTexture=De,this.useMultisampledRTT=Oe}function fg(i,e){function t(n,r=Hn){let s;const a=tt.getTransfer(r);if(n===En)return i.UNSIGNED_BYTE;if(n===to)return i.UNSIGNED_SHORT_4_4_4_4;if(n===no)return i.UNSIGNED_SHORT_5_5_5_1;if(n===rc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===nc)return i.BYTE;if(n===ic)return i.SHORT;if(n===gr)return i.UNSIGNED_SHORT;if(n===eo)return i.INT;if(n===ui)return i.UNSIGNED_INT;if(n===Mn)return i.FLOAT;if(n===In)return i.HALF_FLOAT;if(n===sc)return i.ALPHA;if(n===ac)return i.RGB;if(n===fn)return i.RGBA;if(n===vr)return i.DEPTH_COMPONENT;if(n===xr)return i.DEPTH_STENCIL;if(n===io)return i.RED;if(n===ro)return i.RED_INTEGER;if(n===oc)return i.RG;if(n===so)return i.RG_INTEGER;if(n===ao)return i.RGBA_INTEGER;if(n===Qr||n===es||n===ts||n===ns)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Qr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===es)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ts)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ns)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Qr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===es)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ts)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ns)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ga||n===_a||n===va||n===xa)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ga)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===_a)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===va)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===xa)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ma||n===Sa||n===Ea)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ma||n===Sa)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ea)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ya||n===Ta||n===ba||n===wa||n===Aa||n===Ra||n===Ca||n===Pa||n===La||n===Da||n===Ia||n===Ua||n===Na||n===Fa)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===ya)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ta)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ba)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===wa)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Aa)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ra)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ca)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Pa)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===La)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Da)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ia)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ua)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Na)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Fa)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===is||n===Oa||n===Ba)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===is)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Oa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ba)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===lc||n===za||n===ka||n===Ga)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===is)return s.COMPRESSED_RED_RGTC1_EXT;if(n===za)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ka)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ga)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===_r?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const dg=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class mg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new Ct,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Bt({vertexShader:dg,fragmentShader:pg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ie(new vt(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class gg extends Ki{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,h=null,f=null,p=null,_=null;const v=new mg,m=t.getContextAttributes();let d=null,w=null;const E=[],M=[],D=new Be;let A=null;const R=new Ht;R.viewport=new lt;const P=new Ht;P.viewport=new lt;const y=[R,P],x=new Nh;let C=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let ce=E[j];return ce===void 0&&(ce=new Gs,E[j]=ce),ce.getTargetRaySpace()},this.getControllerGrip=function(j){let ce=E[j];return ce===void 0&&(ce=new Gs,E[j]=ce),ce.getGripSpace()},this.getHand=function(j){let ce=E[j];return ce===void 0&&(ce=new Gs,E[j]=ce),ce.getHandSpace()};function B(j){const ce=M.indexOf(j.inputSource);if(ce===-1)return;const Se=E[ce];Se!==void 0&&(Se.update(j.inputSource,j.frame,c||a),Se.dispatchEvent({type:j.type,data:j.inputSource}))}function q(){r.removeEventListener("select",B),r.removeEventListener("selectstart",B),r.removeEventListener("selectend",B),r.removeEventListener("squeeze",B),r.removeEventListener("squeezestart",B),r.removeEventListener("squeezeend",B),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",Z);for(let j=0;j<E.length;j++){const ce=M[j];ce!==null&&(M[j]=null,E[j].disconnect(ce))}C=null,z=null,v.reset(),e.setRenderTarget(d),p=null,f=null,h=null,r=null,w=null,Ke.stop(),n.isPresenting=!1,e.setPixelRatio(A),e.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){o=j,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(j){c=j},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(d=e.getRenderTarget(),r.addEventListener("select",B),r.addEventListener("selectstart",B),r.addEventListener("selectend",B),r.addEventListener("squeeze",B),r.addEventListener("squeezestart",B),r.addEventListener("squeezeend",B),r.addEventListener("end",q),r.addEventListener("inputsourceschange",Z),m.xrCompatible!==!0&&await t.makeXRCompatible(),A=e.getPixelRatio(),e.getSize(D),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let Se=null,pe=null,De=null;m.depth&&(De=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Se=m.stencil?xr:vr,pe=m.stencil?_r:ui);const je={colorFormat:t.RGBA8,depthFormat:De,scaleFactor:s};h=new XRWebGLBinding(r,t),f=h.createProjectionLayer(je),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),w=new dn(f.textureWidth,f.textureHeight,{format:fn,type:En,depthTexture:new Sc(f.textureWidth,f.textureHeight,pe,void 0,void 0,void 0,void 0,void 0,void 0,Se),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const Se={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,Se),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),w=new dn(p.framebufferWidth,p.framebufferHeight,{format:fn,type:En,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Ke.setContext(r),Ke.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function Z(j){for(let ce=0;ce<j.removed.length;ce++){const Se=j.removed[ce],pe=M.indexOf(Se);pe>=0&&(M[pe]=null,E[pe].disconnect(Se))}for(let ce=0;ce<j.added.length;ce++){const Se=j.added[ce];let pe=M.indexOf(Se);if(pe===-1){for(let je=0;je<E.length;je++)if(je>=M.length){M.push(Se),pe=je;break}else if(M[je]===null){M[je]=Se,pe=je;break}if(pe===-1)break}const De=E[pe];De&&De.connect(Se)}}const Y=new U,re=new U;function K(j,ce,Se){Y.setFromMatrixPosition(ce.matrixWorld),re.setFromMatrixPosition(Se.matrixWorld);const pe=Y.distanceTo(re),De=ce.projectionMatrix.elements,je=Se.projectionMatrix.elements,G=De[14]/(De[10]-1),ne=De[14]/(De[10]+1),H=(De[9]+1)/De[5],W=(De[9]-1)/De[5],T=(De[8]-1)/De[0],Re=(je[8]+1)/je[0],ve=G*T,me=G*Re,Q=pe/(-T+Re),Oe=Q*-T;if(ce.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(Oe),j.translateZ(Q),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert(),De[10]===-1)j.projectionMatrix.copy(ce.projectionMatrix),j.projectionMatrixInverse.copy(ce.projectionMatrixInverse);else{const we=G+Q,Te=ne+Q,Qe=ve-Oe,b=me+(pe-Oe),g=H*ne/Te*we,L=W*ne/Te*we;j.projectionMatrix.makePerspective(Qe,b,g,L,we,Te),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}}function ae(j,ce){ce===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(ce.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;let ce=j.near,Se=j.far;v.texture!==null&&(v.depthNear>0&&(ce=v.depthNear),v.depthFar>0&&(Se=v.depthFar)),x.near=P.near=R.near=ce,x.far=P.far=R.far=Se,(C!==x.near||z!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),C=x.near,z=x.far),R.layers.mask=j.layers.mask|2,P.layers.mask=j.layers.mask|4,x.layers.mask=R.layers.mask|P.layers.mask;const pe=j.parent,De=x.cameras;ae(x,pe);for(let je=0;je<De.length;je++)ae(De[je],pe);De.length===2?K(x,R,P):x.projectionMatrix.copy(R.projectionMatrix),he(j,x,pe)};function he(j,ce,Se){Se===null?j.matrix.copy(ce.matrixWorld):(j.matrix.copy(Se.matrixWorld),j.matrix.invert(),j.matrix.multiply(ce.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(ce.projectionMatrix),j.projectionMatrixInverse.copy(ce.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=Xi*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(j){l=j,f!==null&&(f.fixedFoveation=j),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=j)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(x)};let Pe=null;function Ve(j,ce){if(u=ce.getViewerPose(c||a),_=ce,u!==null){const Se=u.views;p!==null&&(e.setRenderTargetFramebuffer(w,p.framebuffer),e.setRenderTarget(w));let pe=!1;Se.length!==x.cameras.length&&(x.cameras.length=0,pe=!0);for(let G=0;G<Se.length;G++){const ne=Se[G];let H=null;if(p!==null)H=p.getViewport(ne);else{const T=h.getViewSubImage(f,ne);H=T.viewport,G===0&&(e.setRenderTargetTextures(w,T.colorTexture,T.depthStencilTexture),e.setRenderTarget(w))}let W=y[G];W===void 0&&(W=new Ht,W.layers.enable(G),W.viewport=new lt,y[G]=W),W.matrix.fromArray(ne.transform.matrix),W.matrix.decompose(W.position,W.quaternion,W.scale),W.projectionMatrix.fromArray(ne.projectionMatrix),W.projectionMatrixInverse.copy(W.projectionMatrix).invert(),W.viewport.set(H.x,H.y,H.width,H.height),G===0&&(x.matrix.copy(W.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),pe===!0&&x.cameras.push(W)}const De=r.enabledFeatures;if(De&&De.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&h){const G=h.getDepthInformation(Se[0]);G&&G.isValid&&G.texture&&v.init(e,G,r.renderState)}}for(let Se=0;Se<E.length;Se++){const pe=M[Se],De=E[Se];pe!==null&&De!==void 0&&De.update(pe,ce,c||a)}Pe&&Pe(j,ce),ce.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ce}),_=null}const Ke=new bc;Ke.setAnimationLoop(Ve),this.setAnimationLoop=function(j){Pe=j},this.dispose=function(){}}}const ei=new pn,_g=new ct;function vg(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,gc(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,w,E,M){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,M)):d.isMeshMatcapMaterial?(s(m,d),_(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),v(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?l(m,d,w,E):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===zt&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===zt&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const w=e.get(d),E=w.envMap,M=w.envMapRotation;E&&(m.envMap.value=E,ei.copy(M),ei.x*=-1,ei.y*=-1,ei.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(ei.y*=-1,ei.z*=-1),m.envMapRotation.value.setFromMatrix4(_g.makeRotationFromEuler(ei)),m.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,w,E){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*w,m.scale.value=E*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,w){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===zt&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function v(m,d){const w=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function xg(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,E){const M=E.program;n.uniformBlockBinding(w,M)}function c(w,E){let M=r[w.id];M===void 0&&(_(w),M=u(w),r[w.id]=M,w.addEventListener("dispose",m));const D=E.program;n.updateUBOMapping(w,D);const A=e.render.frame;s[w.id]!==A&&(f(w),s[w.id]=A)}function u(w){const E=h();w.__bindingPointIndex=E;const M=i.createBuffer(),D=w.__size,A=w.usage;return i.bindBuffer(i.UNIFORM_BUFFER,M),i.bufferData(i.UNIFORM_BUFFER,D,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,M),M}function h(){for(let w=0;w<o;w++)if(a.indexOf(w)===-1)return a.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(w){const E=r[w.id],M=w.uniforms,D=w.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let A=0,R=M.length;A<R;A++){const P=Array.isArray(M[A])?M[A]:[M[A]];for(let y=0,x=P.length;y<x;y++){const C=P[y];if(p(C,A,y,D)===!0){const z=C.__offset,B=Array.isArray(C.value)?C.value:[C.value];let q=0;for(let Z=0;Z<B.length;Z++){const Y=B[Z],re=v(Y);typeof Y=="number"||typeof Y=="boolean"?(C.__data[0]=Y,i.bufferSubData(i.UNIFORM_BUFFER,z+q,C.__data)):Y.isMatrix3?(C.__data[0]=Y.elements[0],C.__data[1]=Y.elements[1],C.__data[2]=Y.elements[2],C.__data[3]=0,C.__data[4]=Y.elements[3],C.__data[5]=Y.elements[4],C.__data[6]=Y.elements[5],C.__data[7]=0,C.__data[8]=Y.elements[6],C.__data[9]=Y.elements[7],C.__data[10]=Y.elements[8],C.__data[11]=0):(Y.toArray(C.__data,q),q+=re.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,z,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(w,E,M,D){const A=w.value,R=E+"_"+M;if(D[R]===void 0)return typeof A=="number"||typeof A=="boolean"?D[R]=A:D[R]=A.clone(),!0;{const P=D[R];if(typeof A=="number"||typeof A=="boolean"){if(P!==A)return D[R]=A,!0}else if(P.equals(A)===!1)return P.copy(A),!0}return!1}function _(w){const E=w.uniforms;let M=0;const D=16;for(let R=0,P=E.length;R<P;R++){const y=Array.isArray(E[R])?E[R]:[E[R]];for(let x=0,C=y.length;x<C;x++){const z=y[x],B=Array.isArray(z.value)?z.value:[z.value];for(let q=0,Z=B.length;q<Z;q++){const Y=B[q],re=v(Y),K=M%D,ae=K%re.boundary,he=K+ae;M+=ae,he!==0&&D-he<re.storage&&(M+=D-he),z.__data=new Float32Array(re.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=M,M+=re.storage}}}const A=M%D;return A>0&&(M+=D-A),w.__size=M,w.__cache={},this}function v(w){const E={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(E.boundary=4,E.storage=4):w.isVector2?(E.boundary=8,E.storage=8):w.isVector3||w.isColor?(E.boundary=16,E.storage=12):w.isVector4?(E.boundary=16,E.storage=16):w.isMatrix3?(E.boundary=48,E.storage=48):w.isMatrix4?(E.boundary=64,E.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),E}function m(w){const E=w.target;E.removeEventListener("dispose",m);const M=a.indexOf(E.__bindingPointIndex);a.splice(M,1),i.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function d(){for(const w in r)i.deleteBuffer(r[w]);a=[],r={},s={}}return{bind:l,update:c,dispose:d}}class Mg{constructor(e={}){const{canvas:t=Vu(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:f=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;const _=new Uint32Array(4),v=new Int32Array(4);let m=null,d=null;const w=[],E=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=qn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let D=!1;this._outputColorSpace=Ot;let A=0,R=0,P=null,y=-1,x=null;const C=new lt,z=new lt;let B=null;const q=new We(0);let Z=0,Y=t.width,re=t.height,K=1,ae=null,he=null;const Pe=new lt(0,0,Y,re),Ve=new lt(0,0,Y,re);let Ke=!1;const j=new fo;let ce=!1,Se=!1;const pe=new ct,De=new ct,je=new U,G=new lt,ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let H=!1;function W(){return P===null?K:1}let T=n;function Re(S,N){return t.getContext(S,N)}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ja}`),t.addEventListener("webglcontextlost",ge,!1),t.addEventListener("webglcontextrestored",ie,!1),t.addEventListener("webglcontextcreationerror",ee,!1),T===null){const N="webgl2";if(T=Re(N,S),T===null)throw Re(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let ve,me,Q,Oe,we,Te,Qe,b,g,L,O,$,k,_e,le,de,be,J,Me,fe,Ee,oe,Ue,I;function ue(){ve=new Pp(T),ve.init(),oe=new fg(T,ve),me=new yp(T,ve,e,oe),Q=new ug(T,ve),me.reverseDepthBuffer&&f&&Q.buffers.depth.setReversed(!0),Oe=new Ip(T),we=new Zm,Te=new hg(T,ve,Q,we,me,oe,Oe),Qe=new bp(M),b=new Cp(M),g=new Bh(T),Ue=new Sp(T,g),L=new Lp(T,g,Oe,Ue),O=new Np(T,L,g,Oe),Me=new Up(T,me,Te),de=new Tp(we),$=new jm(M,Qe,b,ve,me,Ue,de),k=new vg(M,we),_e=new Qm,le=new sg(ve),J=new Mp(M,Qe,b,Q,O,p,l),be=new lg(M,O,me),I=new xg(T,Oe,me,Q),fe=new Ep(T,ve,Oe),Ee=new Dp(T,ve,Oe),Oe.programs=$.programs,M.capabilities=me,M.extensions=ve,M.properties=we,M.renderLists=_e,M.shadowMap=be,M.state=Q,M.info=Oe}ue();const te=new gg(M,T);this.xr=te,this.getContext=function(){return T},this.getContextAttributes=function(){return T.getContextAttributes()},this.forceContextLoss=function(){const S=ve.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=ve.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return K},this.setPixelRatio=function(S){S!==void 0&&(K=S,this.setSize(Y,re,!1))},this.getSize=function(S){return S.set(Y,re)},this.setSize=function(S,N,V=!0){if(te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Y=S,re=N,t.width=Math.floor(S*K),t.height=Math.floor(N*K),V===!0&&(t.style.width=S+"px",t.style.height=N+"px"),this.setViewport(0,0,S,N)},this.getDrawingBufferSize=function(S){return S.set(Y*K,re*K).floor()},this.setDrawingBufferSize=function(S,N,V){Y=S,re=N,K=V,t.width=Math.floor(S*V),t.height=Math.floor(N*V),this.setViewport(0,0,S,N)},this.getCurrentViewport=function(S){return S.copy(C)},this.getViewport=function(S){return S.copy(Pe)},this.setViewport=function(S,N,V,X){S.isVector4?Pe.set(S.x,S.y,S.z,S.w):Pe.set(S,N,V,X),Q.viewport(C.copy(Pe).multiplyScalar(K).round())},this.getScissor=function(S){return S.copy(Ve)},this.setScissor=function(S,N,V,X){S.isVector4?Ve.set(S.x,S.y,S.z,S.w):Ve.set(S,N,V,X),Q.scissor(z.copy(Ve).multiplyScalar(K).round())},this.getScissorTest=function(){return Ke},this.setScissorTest=function(S){Q.setScissorTest(Ke=S)},this.setOpaqueSort=function(S){ae=S},this.setTransparentSort=function(S){he=S},this.getClearColor=function(S){return S.copy(J.getClearColor())},this.setClearColor=function(){J.setClearColor(...arguments)},this.getClearAlpha=function(){return J.getClearAlpha()},this.setClearAlpha=function(){J.setClearAlpha(...arguments)},this.clear=function(S=!0,N=!0,V=!0){let X=0;if(S){let F=!1;if(P!==null){const se=P.texture.format;F=se===ao||se===so||se===ro}if(F){const se=P.texture.type,ye=se===En||se===ui||se===gr||se===_r||se===to||se===no,Le=J.getClearColor(),Ae=J.getClearAlpha(),Ge=Le.r,He=Le.g,Ne=Le.b;ye?(_[0]=Ge,_[1]=He,_[2]=Ne,_[3]=Ae,T.clearBufferuiv(T.COLOR,0,_)):(v[0]=Ge,v[1]=He,v[2]=Ne,v[3]=Ae,T.clearBufferiv(T.COLOR,0,v))}else X|=T.COLOR_BUFFER_BIT}N&&(X|=T.DEPTH_BUFFER_BIT),V&&(X|=T.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),T.clear(X)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ge,!1),t.removeEventListener("webglcontextrestored",ie,!1),t.removeEventListener("webglcontextcreationerror",ee,!1),J.dispose(),_e.dispose(),le.dispose(),we.dispose(),Qe.dispose(),b.dispose(),O.dispose(),Ue.dispose(),I.dispose(),$.dispose(),te.dispose(),te.removeEventListener("sessionstart",Eo),te.removeEventListener("sessionend",yo),Yn.stop()};function ge(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function ie(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;const S=Oe.autoReset,N=be.enabled,V=be.autoUpdate,X=be.needsUpdate,F=be.type;ue(),Oe.autoReset=S,be.enabled=N,be.autoUpdate=V,be.needsUpdate=X,be.type=F}function ee(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function Ce(S){const N=S.target;N.removeEventListener("dispose",Ce),ke(N)}function ke(S){rt(S),we.remove(S)}function rt(S){const N=we.get(S).programs;N!==void 0&&(N.forEach(function(V){$.releaseProgram(V)}),S.isShaderMaterial&&$.releaseShaderCache(S))}this.renderBufferDirect=function(S,N,V,X,F,se){N===null&&(N=ne);const ye=F.isMesh&&F.matrixWorld.determinant()<0,Le=kc(S,N,V,X,F);Q.setMaterial(X,ye);let Ae=V.index,Ge=1;if(X.wireframe===!0){if(Ae=L.getWireframeAttribute(V),Ae===void 0)return;Ge=2}const He=V.drawRange,Ne=V.attributes.position;let Je=He.start*Ge,at=(He.start+He.count)*Ge;se!==null&&(Je=Math.max(Je,se.start*Ge),at=Math.min(at,(se.start+se.count)*Ge)),Ae!==null?(Je=Math.max(Je,0),at=Math.min(at,Ae.count)):Ne!=null&&(Je=Math.max(Je,0),at=Math.min(at,Ne.count));const mt=at-Je;if(mt<0||mt===1/0)return;Ue.setup(F,X,Le,V,Ae);let ft,ut=fe;if(Ae!==null&&(ft=g.get(Ae),ut=Ee,ut.setIndex(ft)),F.isMesh)X.wireframe===!0?(Q.setLineWidth(X.wireframeLinewidth*W()),ut.setMode(T.LINES)):ut.setMode(T.TRIANGLES);else if(F.isLine){let Fe=X.linewidth;Fe===void 0&&(Fe=1),Q.setLineWidth(Fe*W()),F.isLineSegments?ut.setMode(T.LINES):F.isLineLoop?ut.setMode(T.LINE_LOOP):ut.setMode(T.LINE_STRIP)}else F.isPoints?ut.setMode(T.POINTS):F.isSprite&&ut.setMode(T.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)Bi("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ut.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(ve.get("WEBGL_multi_draw"))ut.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Fe=F._multiDrawStarts,pt=F._multiDrawCounts,it=F._multiDrawCount,Xt=Ae?g.get(Ae).bytesPerElement:1,di=we.get(X).currentProgram.getUniforms();for(let qt=0;qt<it;qt++)di.setValue(T,"_gl_DrawID",qt),ut.render(Fe[qt]/Xt,pt[qt])}else if(F.isInstancedMesh)ut.renderInstances(Je,mt,F.count);else if(V.isInstancedBufferGeometry){const Fe=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,pt=Math.min(V.instanceCount,Fe);ut.renderInstances(Je,mt,pt)}else ut.render(Je,mt)};function nt(S,N,V){S.transparent===!0&&S.side===Pn&&S.forceSinglePass===!1?(S.side=zt,S.needsUpdate=!0,Tr(S,N,V),S.side=Nn,S.needsUpdate=!0,Tr(S,N,V),S.side=Pn):Tr(S,N,V)}this.compile=function(S,N,V=null){V===null&&(V=S),d=le.get(V),d.init(N),E.push(d),V.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(d.pushLight(F),F.castShadow&&d.pushShadow(F))}),S!==V&&S.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(d.pushLight(F),F.castShadow&&d.pushShadow(F))}),d.setupLights();const X=new Set;return S.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const se=F.material;if(se)if(Array.isArray(se))for(let ye=0;ye<se.length;ye++){const Le=se[ye];nt(Le,V,F),X.add(Le)}else nt(se,V,F),X.add(se)}),d=E.pop(),X},this.compileAsync=function(S,N,V=null){const X=this.compile(S,N,V);return new Promise(F=>{function se(){if(X.forEach(function(ye){we.get(ye).currentProgram.isReady()&&X.delete(ye)}),X.size===0){F(S);return}setTimeout(se,10)}ve.get("KHR_parallel_shader_compile")!==null?se():setTimeout(se,10)})};let Dt=null;function Qt(S){Dt&&Dt(S)}function Eo(){Yn.stop()}function yo(){Yn.start()}const Yn=new bc;Yn.setAnimationLoop(Qt),typeof self<"u"&&Yn.setContext(self),this.setAnimationLoop=function(S){Dt=S,te.setAnimationLoop(S),S===null?Yn.stop():Yn.start()},te.addEventListener("sessionstart",Eo),te.addEventListener("sessionend",yo),this.render=function(S,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),te.enabled===!0&&te.isPresenting===!0&&(te.cameraAutoUpdate===!0&&te.updateCamera(N),N=te.getCamera()),S.isScene===!0&&S.onBeforeRender(M,S,N,P),d=le.get(S,E.length),d.init(N),E.push(d),De.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),j.setFromProjectionMatrix(De),Se=this.localClippingEnabled,ce=de.init(this.clippingPlanes,Se),m=_e.get(S,w.length),m.init(),w.push(m),te.enabled===!0&&te.isPresenting===!0){const se=M.xr.getDepthSensingMesh();se!==null&&vs(se,N,-1/0,M.sortObjects)}vs(S,N,0,M.sortObjects),m.finish(),M.sortObjects===!0&&m.sort(ae,he),H=te.enabled===!1||te.isPresenting===!1||te.hasDepthSensing()===!1,H&&J.addToRenderList(m,S),this.info.render.frame++,ce===!0&&de.beginShadows();const V=d.state.shadowsArray;be.render(V,S,N),ce===!0&&de.endShadows(),this.info.autoReset===!0&&this.info.reset();const X=m.opaque,F=m.transmissive;if(d.setupLights(),N.isArrayCamera){const se=N.cameras;if(F.length>0)for(let ye=0,Le=se.length;ye<Le;ye++){const Ae=se[ye];bo(X,F,S,Ae)}H&&J.render(S);for(let ye=0,Le=se.length;ye<Le;ye++){const Ae=se[ye];To(m,S,Ae,Ae.viewport)}}else F.length>0&&bo(X,F,S,N),H&&J.render(S),To(m,S,N);P!==null&&R===0&&(Te.updateMultisampleRenderTarget(P),Te.updateRenderTargetMipmap(P)),S.isScene===!0&&S.onAfterRender(M,S,N),Ue.resetDefaultState(),y=-1,x=null,E.pop(),E.length>0?(d=E[E.length-1],ce===!0&&de.setGlobalState(M.clippingPlanes,d.state.camera)):d=null,w.pop(),w.length>0?m=w[w.length-1]:m=null};function vs(S,N,V,X){if(S.visible===!1)return;if(S.layers.test(N.layers)){if(S.isGroup)V=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(N);else if(S.isLight)d.pushLight(S),S.castShadow&&d.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||j.intersectsSprite(S)){X&&G.setFromMatrixPosition(S.matrixWorld).applyMatrix4(De);const ye=O.update(S),Le=S.material;Le.visible&&m.push(S,ye,Le,V,G.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||j.intersectsObject(S))){const ye=O.update(S),Le=S.material;if(X&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),G.copy(S.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),G.copy(ye.boundingSphere.center)),G.applyMatrix4(S.matrixWorld).applyMatrix4(De)),Array.isArray(Le)){const Ae=ye.groups;for(let Ge=0,He=Ae.length;Ge<He;Ge++){const Ne=Ae[Ge],Je=Le[Ne.materialIndex];Je&&Je.visible&&m.push(S,ye,Je,V,G.z,Ne)}}else Le.visible&&m.push(S,ye,Le,V,G.z,null)}}const se=S.children;for(let ye=0,Le=se.length;ye<Le;ye++)vs(se[ye],N,V,X)}function To(S,N,V,X){const F=S.opaque,se=S.transmissive,ye=S.transparent;d.setupLightsView(V),ce===!0&&de.setGlobalState(M.clippingPlanes,V),X&&Q.viewport(C.copy(X)),F.length>0&&yr(F,N,V),se.length>0&&yr(se,N,V),ye.length>0&&yr(ye,N,V),Q.buffers.depth.setTest(!0),Q.buffers.depth.setMask(!0),Q.buffers.color.setMask(!0),Q.setPolygonOffset(!1)}function bo(S,N,V,X){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[X.id]===void 0&&(d.state.transmissionRenderTarget[X.id]=new dn(1,1,{generateMipmaps:!0,type:ve.has("EXT_color_buffer_half_float")||ve.has("EXT_color_buffer_float")?In:En,minFilter:oi,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:tt.workingColorSpace}));const se=d.state.transmissionRenderTarget[X.id],ye=X.viewport||C;se.setSize(ye.z*M.transmissionResolutionScale,ye.w*M.transmissionResolutionScale);const Le=M.getRenderTarget(),Ae=M.getActiveCubeFace(),Ge=M.getActiveMipmapLevel();M.setRenderTarget(se),M.getClearColor(q),Z=M.getClearAlpha(),Z<1&&M.setClearColor(16777215,.5),M.clear(),H&&J.render(V);const He=M.toneMapping;M.toneMapping=qn;const Ne=X.viewport;if(X.viewport!==void 0&&(X.viewport=void 0),d.setupLightsView(X),ce===!0&&de.setGlobalState(M.clippingPlanes,X),yr(S,V,X),Te.updateMultisampleRenderTarget(se),Te.updateRenderTargetMipmap(se),ve.has("WEBGL_multisampled_render_to_texture")===!1){let Je=!1;for(let at=0,mt=N.length;at<mt;at++){const ft=N[at],ut=ft.object,Fe=ft.geometry,pt=ft.material,it=ft.group;if(pt.side===Pn&&ut.layers.test(X.layers)){const Xt=pt.side;pt.side=zt,pt.needsUpdate=!0,wo(ut,V,X,Fe,pt,it),pt.side=Xt,pt.needsUpdate=!0,Je=!0}}Je===!0&&(Te.updateMultisampleRenderTarget(se),Te.updateRenderTargetMipmap(se))}M.setRenderTarget(Le,Ae,Ge),M.setClearColor(q,Z),Ne!==void 0&&(X.viewport=Ne),M.toneMapping=He}function yr(S,N,V){const X=N.isScene===!0?N.overrideMaterial:null;for(let F=0,se=S.length;F<se;F++){const ye=S[F],Le=ye.object,Ae=ye.geometry,Ge=ye.group;let He=ye.material;He.allowOverride===!0&&X!==null&&(He=X),Le.layers.test(V.layers)&&wo(Le,N,V,Ae,He,Ge)}}function wo(S,N,V,X,F,se){S.onBeforeRender(M,N,V,X,F,se),S.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),F.onBeforeRender(M,N,V,X,S,se),F.transparent===!0&&F.side===Pn&&F.forceSinglePass===!1?(F.side=zt,F.needsUpdate=!0,M.renderBufferDirect(V,N,X,F,S,se),F.side=Nn,F.needsUpdate=!0,M.renderBufferDirect(V,N,X,F,S,se),F.side=Pn):M.renderBufferDirect(V,N,X,F,S,se),S.onAfterRender(M,N,V,X,F,se)}function Tr(S,N,V){N.isScene!==!0&&(N=ne);const X=we.get(S),F=d.state.lights,se=d.state.shadowsArray,ye=F.state.version,Le=$.getParameters(S,F.state,se,N,V),Ae=$.getProgramCacheKey(Le);let Ge=X.programs;X.environment=S.isMeshStandardMaterial?N.environment:null,X.fog=N.fog,X.envMap=(S.isMeshStandardMaterial?b:Qe).get(S.envMap||X.environment),X.envMapRotation=X.environment!==null&&S.envMap===null?N.environmentRotation:S.envMapRotation,Ge===void 0&&(S.addEventListener("dispose",Ce),Ge=new Map,X.programs=Ge);let He=Ge.get(Ae);if(He!==void 0){if(X.currentProgram===He&&X.lightsStateVersion===ye)return Ro(S,Le),He}else Le.uniforms=$.getUniforms(S),S.onBeforeCompile(Le,M),He=$.acquireProgram(Le,Ae),Ge.set(Ae,He),X.uniforms=Le.uniforms;const Ne=X.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ne.clippingPlanes=de.uniform),Ro(S,Le),X.needsLights=Vc(S),X.lightsStateVersion=ye,X.needsLights&&(Ne.ambientLightColor.value=F.state.ambient,Ne.lightProbe.value=F.state.probe,Ne.directionalLights.value=F.state.directional,Ne.directionalLightShadows.value=F.state.directionalShadow,Ne.spotLights.value=F.state.spot,Ne.spotLightShadows.value=F.state.spotShadow,Ne.rectAreaLights.value=F.state.rectArea,Ne.ltc_1.value=F.state.rectAreaLTC1,Ne.ltc_2.value=F.state.rectAreaLTC2,Ne.pointLights.value=F.state.point,Ne.pointLightShadows.value=F.state.pointShadow,Ne.hemisphereLights.value=F.state.hemi,Ne.directionalShadowMap.value=F.state.directionalShadowMap,Ne.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Ne.spotShadowMap.value=F.state.spotShadowMap,Ne.spotLightMatrix.value=F.state.spotLightMatrix,Ne.spotLightMap.value=F.state.spotLightMap,Ne.pointShadowMap.value=F.state.pointShadowMap,Ne.pointShadowMatrix.value=F.state.pointShadowMatrix),X.currentProgram=He,X.uniformsList=null,He}function Ao(S){if(S.uniformsList===null){const N=S.currentProgram.getUniforms();S.uniformsList=ss.seqWithValue(N.seq,S.uniforms)}return S.uniformsList}function Ro(S,N){const V=we.get(S);V.outputColorSpace=N.outputColorSpace,V.batching=N.batching,V.batchingColor=N.batchingColor,V.instancing=N.instancing,V.instancingColor=N.instancingColor,V.instancingMorph=N.instancingMorph,V.skinning=N.skinning,V.morphTargets=N.morphTargets,V.morphNormals=N.morphNormals,V.morphColors=N.morphColors,V.morphTargetsCount=N.morphTargetsCount,V.numClippingPlanes=N.numClippingPlanes,V.numIntersection=N.numClipIntersection,V.vertexAlphas=N.vertexAlphas,V.vertexTangents=N.vertexTangents,V.toneMapping=N.toneMapping}function kc(S,N,V,X,F){N.isScene!==!0&&(N=ne),Te.resetTextureUnits();const se=N.fog,ye=X.isMeshStandardMaterial?N.environment:null,Le=P===null?M.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:Wi,Ae=(X.isMeshStandardMaterial?b:Qe).get(X.envMap||ye),Ge=X.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,He=!!V.attributes.tangent&&(!!X.normalMap||X.anisotropy>0),Ne=!!V.morphAttributes.position,Je=!!V.morphAttributes.normal,at=!!V.morphAttributes.color;let mt=qn;X.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(mt=M.toneMapping);const ft=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,ut=ft!==void 0?ft.length:0,Fe=we.get(X),pt=d.state.lights;if(ce===!0&&(Se===!0||S!==x)){const It=S===x&&X.id===y;de.setState(X,S,It)}let it=!1;X.version===Fe.__version?(Fe.needsLights&&Fe.lightsStateVersion!==pt.state.version||Fe.outputColorSpace!==Le||F.isBatchedMesh&&Fe.batching===!1||!F.isBatchedMesh&&Fe.batching===!0||F.isBatchedMesh&&Fe.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Fe.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Fe.instancing===!1||!F.isInstancedMesh&&Fe.instancing===!0||F.isSkinnedMesh&&Fe.skinning===!1||!F.isSkinnedMesh&&Fe.skinning===!0||F.isInstancedMesh&&Fe.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Fe.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Fe.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Fe.instancingMorph===!1&&F.morphTexture!==null||Fe.envMap!==Ae||X.fog===!0&&Fe.fog!==se||Fe.numClippingPlanes!==void 0&&(Fe.numClippingPlanes!==de.numPlanes||Fe.numIntersection!==de.numIntersection)||Fe.vertexAlphas!==Ge||Fe.vertexTangents!==He||Fe.morphTargets!==Ne||Fe.morphNormals!==Je||Fe.morphColors!==at||Fe.toneMapping!==mt||Fe.morphTargetsCount!==ut)&&(it=!0):(it=!0,Fe.__version=X.version);let Xt=Fe.currentProgram;it===!0&&(Xt=Tr(X,N,F));let di=!1,qt=!1,tr=!1;const dt=Xt.getUniforms(),en=Fe.uniforms;if(Q.useProgram(Xt.program)&&(di=!0,qt=!0,tr=!0),X.id!==y&&(y=X.id,qt=!0),di||x!==S){Q.buffers.depth.getReversed()?(pe.copy(S.projectionMatrix),Wu(pe),Xu(pe),dt.setValue(T,"projectionMatrix",pe)):dt.setValue(T,"projectionMatrix",S.projectionMatrix),dt.setValue(T,"viewMatrix",S.matrixWorldInverse);const Gt=dt.map.cameraPosition;Gt!==void 0&&Gt.setValue(T,je.setFromMatrixPosition(S.matrixWorld)),me.logarithmicDepthBuffer&&dt.setValue(T,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(X.isMeshPhongMaterial||X.isMeshToonMaterial||X.isMeshLambertMaterial||X.isMeshBasicMaterial||X.isMeshStandardMaterial||X.isShaderMaterial)&&dt.setValue(T,"isOrthographic",S.isOrthographicCamera===!0),x!==S&&(x=S,qt=!0,tr=!0)}if(F.isSkinnedMesh){dt.setOptional(T,F,"bindMatrix"),dt.setOptional(T,F,"bindMatrixInverse");const It=F.skeleton;It&&(It.boneTexture===null&&It.computeBoneTexture(),dt.setValue(T,"boneTexture",It.boneTexture,Te))}F.isBatchedMesh&&(dt.setOptional(T,F,"batchingTexture"),dt.setValue(T,"batchingTexture",F._matricesTexture,Te),dt.setOptional(T,F,"batchingIdTexture"),dt.setValue(T,"batchingIdTexture",F._indirectTexture,Te),dt.setOptional(T,F,"batchingColorTexture"),F._colorsTexture!==null&&dt.setValue(T,"batchingColorTexture",F._colorsTexture,Te));const tn=V.morphAttributes;if((tn.position!==void 0||tn.normal!==void 0||tn.color!==void 0)&&Me.update(F,V,Xt),(qt||Fe.receiveShadow!==F.receiveShadow)&&(Fe.receiveShadow=F.receiveShadow,dt.setValue(T,"receiveShadow",F.receiveShadow)),X.isMeshGouraudMaterial&&X.envMap!==null&&(en.envMap.value=Ae,en.flipEnvMap.value=Ae.isCubeTexture&&Ae.isRenderTargetTexture===!1?-1:1),X.isMeshStandardMaterial&&X.envMap===null&&N.environment!==null&&(en.envMapIntensity.value=N.environmentIntensity),qt&&(dt.setValue(T,"toneMappingExposure",M.toneMappingExposure),Fe.needsLights&&Gc(en,tr),se&&X.fog===!0&&k.refreshFogUniforms(en,se),k.refreshMaterialUniforms(en,X,K,re,d.state.transmissionRenderTarget[S.id]),ss.upload(T,Ao(Fe),en,Te)),X.isShaderMaterial&&X.uniformsNeedUpdate===!0&&(ss.upload(T,Ao(Fe),en,Te),X.uniformsNeedUpdate=!1),X.isSpriteMaterial&&dt.setValue(T,"center",F.center),dt.setValue(T,"modelViewMatrix",F.modelViewMatrix),dt.setValue(T,"normalMatrix",F.normalMatrix),dt.setValue(T,"modelMatrix",F.matrixWorld),X.isShaderMaterial||X.isRawShaderMaterial){const It=X.uniformsGroups;for(let Gt=0,xs=It.length;Gt<xs;Gt++){const $n=It[Gt];I.update($n,Xt),I.bind($n,Xt)}}return Xt}function Gc(S,N){S.ambientLightColor.needsUpdate=N,S.lightProbe.needsUpdate=N,S.directionalLights.needsUpdate=N,S.directionalLightShadows.needsUpdate=N,S.pointLights.needsUpdate=N,S.pointLightShadows.needsUpdate=N,S.spotLights.needsUpdate=N,S.spotLightShadows.needsUpdate=N,S.rectAreaLights.needsUpdate=N,S.hemisphereLights.needsUpdate=N}function Vc(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(S,N,V){const X=we.get(S);X.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,X.__autoAllocateDepthBuffer===!1&&(X.__useRenderToTexture=!1),we.get(S.texture).__webglTexture=N,we.get(S.depthTexture).__webglTexture=X.__autoAllocateDepthBuffer?void 0:V,X.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,N){const V=we.get(S);V.__webglFramebuffer=N,V.__useDefaultFramebuffer=N===void 0};const Hc=T.createFramebuffer();this.setRenderTarget=function(S,N=0,V=0){P=S,A=N,R=V;let X=!0,F=null,se=!1,ye=!1;if(S){const Ae=we.get(S);if(Ae.__useDefaultFramebuffer!==void 0)Q.bindFramebuffer(T.FRAMEBUFFER,null),X=!1;else if(Ae.__webglFramebuffer===void 0)Te.setupRenderTarget(S);else if(Ae.__hasExternalTextures)Te.rebindTextures(S,we.get(S.texture).__webglTexture,we.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const Ne=S.depthTexture;if(Ae.__boundDepthTexture!==Ne){if(Ne!==null&&we.has(Ne)&&(S.width!==Ne.image.width||S.height!==Ne.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Te.setupDepthRenderbuffer(S)}}const Ge=S.texture;(Ge.isData3DTexture||Ge.isDataArrayTexture||Ge.isCompressedArrayTexture)&&(ye=!0);const He=we.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(He[N])?F=He[N][V]:F=He[N],se=!0):S.samples>0&&Te.useMultisampledRTT(S)===!1?F=we.get(S).__webglMultisampledFramebuffer:Array.isArray(He)?F=He[V]:F=He,C.copy(S.viewport),z.copy(S.scissor),B=S.scissorTest}else C.copy(Pe).multiplyScalar(K).floor(),z.copy(Ve).multiplyScalar(K).floor(),B=Ke;if(V!==0&&(F=Hc),Q.bindFramebuffer(T.FRAMEBUFFER,F)&&X&&Q.drawBuffers(S,F),Q.viewport(C),Q.scissor(z),Q.setScissorTest(B),se){const Ae=we.get(S.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_CUBE_MAP_POSITIVE_X+N,Ae.__webglTexture,V)}else if(ye){const Ae=we.get(S.texture),Ge=N;T.framebufferTextureLayer(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,Ae.__webglTexture,V,Ge)}else if(S!==null&&V!==0){const Ae=we.get(S.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Ae.__webglTexture,V)}y=-1},this.readRenderTargetPixels=function(S,N,V,X,F,se,ye,Le=0){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ae=we.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&ye!==void 0&&(Ae=Ae[ye]),Ae){Q.bindFramebuffer(T.FRAMEBUFFER,Ae);try{const Ge=S.textures[Le],He=Ge.format,Ne=Ge.type;if(!me.textureFormatReadable(He)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!me.textureTypeReadable(Ne)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=S.width-X&&V>=0&&V<=S.height-F&&(S.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Le),T.readPixels(N,V,X,F,oe.convert(He),oe.convert(Ne),se))}finally{const Ge=P!==null?we.get(P).__webglFramebuffer:null;Q.bindFramebuffer(T.FRAMEBUFFER,Ge)}}},this.readRenderTargetPixelsAsync=async function(S,N,V,X,F,se,ye,Le=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ae=we.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&ye!==void 0&&(Ae=Ae[ye]),Ae)if(N>=0&&N<=S.width-X&&V>=0&&V<=S.height-F){Q.bindFramebuffer(T.FRAMEBUFFER,Ae);const Ge=S.textures[Le],He=Ge.format,Ne=Ge.type;if(!me.textureFormatReadable(He))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!me.textureTypeReadable(Ne))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Je=T.createBuffer();T.bindBuffer(T.PIXEL_PACK_BUFFER,Je),T.bufferData(T.PIXEL_PACK_BUFFER,se.byteLength,T.STREAM_READ),S.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Le),T.readPixels(N,V,X,F,oe.convert(He),oe.convert(Ne),0);const at=P!==null?we.get(P).__webglFramebuffer:null;Q.bindFramebuffer(T.FRAMEBUFFER,at);const mt=T.fenceSync(T.SYNC_GPU_COMMANDS_COMPLETE,0);return T.flush(),await Hu(T,mt,4),T.bindBuffer(T.PIXEL_PACK_BUFFER,Je),T.getBufferSubData(T.PIXEL_PACK_BUFFER,0,se),T.deleteBuffer(Je),T.deleteSync(mt),se}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,N=null,V=0){const X=Math.pow(2,-V),F=Math.floor(S.image.width*X),se=Math.floor(S.image.height*X),ye=N!==null?N.x:0,Le=N!==null?N.y:0;Te.setTexture2D(S,0),T.copyTexSubImage2D(T.TEXTURE_2D,V,0,0,ye,Le,F,se),Q.unbindTexture()};const Wc=T.createFramebuffer(),Xc=T.createFramebuffer();this.copyTextureToTexture=function(S,N,V=null,X=null,F=0,se=null){se===null&&(F!==0?(Bi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),se=F,F=0):se=0);let ye,Le,Ae,Ge,He,Ne,Je,at,mt;const ft=S.isCompressedTexture?S.mipmaps[se]:S.image;if(V!==null)ye=V.max.x-V.min.x,Le=V.max.y-V.min.y,Ae=V.isBox3?V.max.z-V.min.z:1,Ge=V.min.x,He=V.min.y,Ne=V.isBox3?V.min.z:0;else{const tn=Math.pow(2,-F);ye=Math.floor(ft.width*tn),Le=Math.floor(ft.height*tn),S.isDataArrayTexture?Ae=ft.depth:S.isData3DTexture?Ae=Math.floor(ft.depth*tn):Ae=1,Ge=0,He=0,Ne=0}X!==null?(Je=X.x,at=X.y,mt=X.z):(Je=0,at=0,mt=0);const ut=oe.convert(N.format),Fe=oe.convert(N.type);let pt;N.isData3DTexture?(Te.setTexture3D(N,0),pt=T.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(Te.setTexture2DArray(N,0),pt=T.TEXTURE_2D_ARRAY):(Te.setTexture2D(N,0),pt=T.TEXTURE_2D),T.pixelStorei(T.UNPACK_FLIP_Y_WEBGL,N.flipY),T.pixelStorei(T.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),T.pixelStorei(T.UNPACK_ALIGNMENT,N.unpackAlignment);const it=T.getParameter(T.UNPACK_ROW_LENGTH),Xt=T.getParameter(T.UNPACK_IMAGE_HEIGHT),di=T.getParameter(T.UNPACK_SKIP_PIXELS),qt=T.getParameter(T.UNPACK_SKIP_ROWS),tr=T.getParameter(T.UNPACK_SKIP_IMAGES);T.pixelStorei(T.UNPACK_ROW_LENGTH,ft.width),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,ft.height),T.pixelStorei(T.UNPACK_SKIP_PIXELS,Ge),T.pixelStorei(T.UNPACK_SKIP_ROWS,He),T.pixelStorei(T.UNPACK_SKIP_IMAGES,Ne);const dt=S.isDataArrayTexture||S.isData3DTexture,en=N.isDataArrayTexture||N.isData3DTexture;if(S.isDepthTexture){const tn=we.get(S),It=we.get(N),Gt=we.get(tn.__renderTarget),xs=we.get(It.__renderTarget);Q.bindFramebuffer(T.READ_FRAMEBUFFER,Gt.__webglFramebuffer),Q.bindFramebuffer(T.DRAW_FRAMEBUFFER,xs.__webglFramebuffer);for(let $n=0;$n<Ae;$n++)dt&&(T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,we.get(S).__webglTexture,F,Ne+$n),T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,we.get(N).__webglTexture,se,mt+$n)),T.blitFramebuffer(Ge,He,ye,Le,Je,at,ye,Le,T.DEPTH_BUFFER_BIT,T.NEAREST);Q.bindFramebuffer(T.READ_FRAMEBUFFER,null),Q.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else if(F!==0||S.isRenderTargetTexture||we.has(S)){const tn=we.get(S),It=we.get(N);Q.bindFramebuffer(T.READ_FRAMEBUFFER,Wc),Q.bindFramebuffer(T.DRAW_FRAMEBUFFER,Xc);for(let Gt=0;Gt<Ae;Gt++)dt?T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,tn.__webglTexture,F,Ne+Gt):T.framebufferTexture2D(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,tn.__webglTexture,F),en?T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,It.__webglTexture,se,mt+Gt):T.framebufferTexture2D(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,It.__webglTexture,se),F!==0?T.blitFramebuffer(Ge,He,ye,Le,Je,at,ye,Le,T.COLOR_BUFFER_BIT,T.NEAREST):en?T.copyTexSubImage3D(pt,se,Je,at,mt+Gt,Ge,He,ye,Le):T.copyTexSubImage2D(pt,se,Je,at,Ge,He,ye,Le);Q.bindFramebuffer(T.READ_FRAMEBUFFER,null),Q.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else en?S.isDataTexture||S.isData3DTexture?T.texSubImage3D(pt,se,Je,at,mt,ye,Le,Ae,ut,Fe,ft.data):N.isCompressedArrayTexture?T.compressedTexSubImage3D(pt,se,Je,at,mt,ye,Le,Ae,ut,ft.data):T.texSubImage3D(pt,se,Je,at,mt,ye,Le,Ae,ut,Fe,ft):S.isDataTexture?T.texSubImage2D(T.TEXTURE_2D,se,Je,at,ye,Le,ut,Fe,ft.data):S.isCompressedTexture?T.compressedTexSubImage2D(T.TEXTURE_2D,se,Je,at,ft.width,ft.height,ut,ft.data):T.texSubImage2D(T.TEXTURE_2D,se,Je,at,ye,Le,ut,Fe,ft);T.pixelStorei(T.UNPACK_ROW_LENGTH,it),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,Xt),T.pixelStorei(T.UNPACK_SKIP_PIXELS,di),T.pixelStorei(T.UNPACK_SKIP_ROWS,qt),T.pixelStorei(T.UNPACK_SKIP_IMAGES,tr),se===0&&N.generateMipmaps&&T.generateMipmap(pt),Q.unbindTexture()},this.copyTextureToTexture3D=function(S,N,V=null,X=null,F=0){return Bi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(S,N,V,X,F)},this.initRenderTarget=function(S){we.get(S).__webglFramebuffer===void 0&&Te.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?Te.setTextureCube(S,0):S.isData3DTexture?Te.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?Te.setTexture2DArray(S,0):Te.setTexture2D(S,0),Q.unbindTexture()},this.resetState=function(){A=0,R=0,P=null,Q.reset(),Ue.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=tt._getDrawingBufferColorSpace(e),t.unpackColorSpace=tt._getUnpackColorSpace()}}const as={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class Cg extends er{constructor(){super(),this.uniforms=Sr.clone(Kr.uniforms),this.material=new Eh({name:Kr.name,uniforms:this.uniforms,vertexShader:Kr.vertexShader,fragmentShader:Kr.fragmentShader}),this._fsQuad=new Mo(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},tt.getTransfer(this._outputColorSpace)===st&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===Kl?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===jl?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===Zl?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Qa?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Ql?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===ec?this.material.defines.NEUTRAL_TONE_MAPPING="":this._toneMapping===Jl&&(this.material.defines.CUSTOM_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}const Pg={name:"Galerie JP",waehrung:"EUR",email:"",web3formsKey:""},Lg=[{id:"moderne",name:"Moderne",saal:"Saal I",beschreibung:"Farbfelder und stille Kompositionen der Gegenwart."},{id:"abstraktion",name:"Abstraktion",saal:"Saal II",beschreibung:"Gestische Malerei — Bewegung, Linie, Energie."},{id:"fotografie",name:"Fotografie",saal:"Saal III",beschreibung:"Monochrome Arbeiten zwischen Licht und Schatten."}],Dg=[{id:"w-001",raum:"moderne",titel:"Stille Fläche II",kuenstler:"Mara Weidenfeld",jahr:2024,technik:"Öl auf Leinwand",breite_cm:120,hoehe_cm:150,preis:8400,bild:null,verkauft:!1,beschreibung:"Zwei schwebende Farbfelder in gedämpftem Ocker und Nachtblau — ein Werk über das Atmen zwischen den Flächen."},{id:"w-002",raum:"moderne",titel:"Horizontlinie, früh",kuenstler:"Mara Weidenfeld",jahr:2023,technik:"Öl auf Leinwand",breite_cm:160,hoehe_cm:110,preis:9800,bild:null,verkauft:!1,beschreibung:"Ein breiter, ruhiger Horizont in drei Tonstufen. Entstanden in der Serie „Küstenlicht“."},{id:"w-003",raum:"moderne",titel:"Ockerfeld",kuenstler:"Jonas Brandt",jahr:2025,technik:"Acryl und Pigment auf Leinwand",breite_cm:100,hoehe_cm:100,preis:6200,bild:null,verkauft:!0,beschreibung:"Monochromes Pigmentfeld mit fein gebrochener Oberfläche."},{id:"w-004",raum:"moderne",titel:"Zwei Räume",kuenstler:"Jonas Brandt",jahr:2024,technik:"Öl auf Leinwand",breite_cm:90,hoehe_cm:130,preis:7100,bild:null,verkauft:!1,beschreibung:"Architektonische Farbteilung — innen und außen zugleich."},{id:"w-005",raum:"abstraktion",titel:"Aufwind",kuenstler:"Selin Okur",jahr:2025,technik:"Mischtechnik auf Leinwand",breite_cm:140,hoehe_cm:180,preis:12400,bild:null,verkauft:!1,beschreibung:"Weit ausholende Gesten in Umbra und Zinnober — das zentrale Werk der aktuellen Ausstellung."},{id:"w-006",raum:"abstraktion",titel:"Notat 14",kuenstler:"Selin Okur",jahr:2024,technik:"Tusche und Acryl auf Leinwand",breite_cm:110,hoehe_cm:90,preis:5400,bild:null,verkauft:!1,beschreibung:"Kalligrafische Verdichtung, in einer Sitzung entstanden."},{id:"w-007",raum:"abstraktion",titel:"Schwarm",kuenstler:"Anton Hilbert",jahr:2023,technik:"Acryl auf Leinwand",breite_cm:130,hoehe_cm:130,preis:8900,bild:null,verkauft:!1,beschreibung:"Hunderte kurzer Setzungen, die sich zu einer Bewegung ordnen."},{id:"w-008",raum:"abstraktion",titel:"Bruchkante",kuenstler:"Anton Hilbert",jahr:2025,technik:"Öl und Kohle auf Leinwand",breite_cm:95,hoehe_cm:140,preis:7600,bild:null,verkauft:!1,beschreibung:"Eine einzige dunkle Diagonale teilt das Bildfeld."},{id:"w-009",raum:"fotografie",titel:"Nebelkamm I",kuenstler:"Ruth Ellmann",jahr:2022,technik:"Silbergelatine-Abzug, gerahmt",breite_cm:110,hoehe_cm:80,preis:3800,bild:null,verkauft:!1,beschreibung:"Bergrücken im Morgennebel, Edition 1/1 — als Unikat abgezogen."},{id:"w-010",raum:"fotografie",titel:"Nebelkamm II",kuenstler:"Ruth Ellmann",jahr:2022,technik:"Silbergelatine-Abzug, gerahmt",breite_cm:110,hoehe_cm:80,preis:3800,bild:null,verkauft:!1,beschreibung:"Gegenstück zu Nebelkamm I, aufgenommen eine Stunde später."},{id:"w-011",raum:"fotografie",titel:"Fassade, Nacht",kuenstler:"Ruth Ellmann",jahr:2024,technik:"Pigmentdruck auf Baryt, gerahmt",breite_cm:90,hoehe_cm:120,preis:4600,bild:null,verkauft:!1,beschreibung:"Ein einzelnes erleuchtetes Fenster in dunkler Rasterfassade."},{id:"w-012",raum:"fotografie",titel:"Gezeiten",kuenstler:"Paul Andersson",jahr:2023,technik:"Langzeitbelichtung, Pigmentdruck, gerahmt",breite_cm:150,hoehe_cm:100,preis:5200,bild:null,verkauft:!1,beschreibung:"Zwanzig Minuten Meer, zu einer einzigen weichen Fläche verdichtet."}],So={galerie:Pg,raeume:Lg,werke:Dg},Ig=typeof window<"u"&&new URLSearchParams(window.location.search).get("touch")==="1",kt=typeof window<"u"&&(Ig||matchMedia("(pointer: coarse)").matches),Pc=kt&&((navigator.hardwareConcurrency||8)<=4||(navigator.deviceMemory||8)<=4),Ug=matchMedia("(max-width: 480px)"),Ng=matchMedia("(max-height: 480px) and (orientation: landscape)");function os(){return kt&&Ug.matches&&!Ng.matches}const Ni=typeof window<"u"&&matchMedia("(prefers-reduced-motion: reduce)").matches;document.documentElement.classList.toggle("touch",kt);const ze={raum:{breite:14,tiefe:10,hoehe:4.2,wandstaerke:.3,tuerBreite:2.6,tuerHoehe:3.1},besucher:{augenhoehe:1.62,gehtempo:2.4,drehempfindlichkeit:.0042,bobAmplitude:.016,bobFrequenz:1.85,bobRolle:.0035,fovBasis:58,fovGehen:61,fovFokus:47,fovIntro:63},licht:{belichtung:1.15,belichtungIntro:.82,belichtungFokus:.92,grundlicht:.34,saalSpot:340,kegelDeckkraft:.07,poolWand:.5,poolBoden:.11,schattenRahmen:.3},klang:{master:.5,raumton:.01,schritt:.16,hallAnteil:.35},mobil:{dprCap:1.5,dprCapSchwach:1.25,tapToleranzPx:14,joystickRadiusPx:44,joystickDeadzone:.18,platzhalterHoehe:640,hFovZielGrad:44},haengung:{plaetzeLaengswand:3,plaetzeStirnwand:2},saalStile:{standard:{wand:15393750,spotFarbe:16768174,lichtFaktor:1,poolFaktor:1,lettering:"#2b2721",bank:4863268},moderne:{wand:15393750,spotFarbe:16768174,lichtFaktor:1,poolFaktor:1,lettering:"#2b2721",bank:4863268},abstraktion:{wand:15132127,spotFarbe:16770758,lichtFaktor:1,poolFaktor:1.15,lettering:"#2b2721",bank:3352606},fotografie:{wand:3815219,spotFarbe:16774116,lichtFaktor:.55,poolFaktor:1.5,lettering:"#ede7dc",bank:1644308}}},Fg=typeof window<"u"&&Math.min(screen.width,screen.height)<820,Fi=kt||Fg?"B":"A",Zt=So.galerie,ht=So.raeume,Fn=So.werke;let qa=null;function Og(i,e=null){Object.assign(Zt,i.galerie),ht.length=0,ht.push(...i.raeume),Fn.length=0,Fn.push(...i.werke),qa=e,ci.clear()}let Js=null,Ul=null;function Bg(){return(!Js||Ul!==Zt.waehrung)&&(Ul=Zt.waehrung,Js=new Intl.NumberFormat("de-DE",{style:"currency",currency:Zt.waehrung||"EUR",maximumFractionDigits:0})),Js}function Kt(i){return Fn.find(e=>e.id===i)}function ls(i){return Fn.filter(e=>e.raum===i)}function zg(i){return ht.find(e=>e.id===i)}function un(i){return i==null?"Preis auf Anfrage":Bg().format(i)}const ci=new Map;function Lc(i){return i.bild?{typ:"url",wert:qa?qa+i.bild:`werke/${i.bild}`}:(ci.has(i.id)||ci.set(i.id,Ic(i)),{typ:"canvas",wert:ci.get(i.id)})}function kg(i){const e=Lc(i);return e.typ==="url"?e.wert:e.wert.toDataURL("image/jpeg",.7)}function Dc(i){return ci.has(i.id)||ci.set(i.id,Ic(i)),ci.get(i.id)}function Qs(i,e){i.onerror=()=>{i.onerror=null,i.src=Dc(e).toDataURL("image/jpeg",.7)},i.src=kg(e)}function Gg(i){let e=2166136261;for(let t=0;t<i.length;t++)e^=i.charCodeAt(t),e=Math.imul(e,16777619);return e>>>0}function Vg(i){let e=i;return function(){e|=0,e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}function Ic(i){const e=Vg(Gg(i.id+i.titel)),t=i.breite_cm/i.hoehe_cm,n=kt?ze.mobil.platzhalterHoehe:1024,r=Math.round(n*t),s=document.createElement("canvas");s.width=r,s.height=n;const a=s.getContext("2d");if(i.raum==="fotografie"?qg(a,r,n,e):i.raum==="abstraktion"?Wg(a,r,n,e):Hg(a,r,n,e),Pc||Yg(a,r,n,e,i.raum==="fotografie"?26:10),i.raum!=="fotografie"){a.fillStyle="rgba(255,255,255,0.028)";for(let o=0;o<r;o+=3)a.fillRect(o,0,1,n);a.fillStyle="rgba(0,0,0,0.028)";for(let o=0;o<n;o+=3)a.fillRect(0,o,r,1)}return s}const Nl=[{grund:"#ded4bd",felder:["#1f2b3e","#b5854a"],glut:"#e8d9b8"},{grund:"#d9cdb8",felder:["#933f28","#3c3a35"],glut:"#e2b98e"},{grund:"#d6d2c4",felder:["#55654f","#8a4a30"],glut:"#dccfa8"},{grund:"#cfc4ae",felder:["#2e4258","#b99a55"],glut:"#e5d5ac"},{grund:"#4a4238",felder:["#1c1a17","#8f6a3a"],glut:"#c9a468"}];function Fl(i,e,t,n,r,s,a){i.fillStyle=s;for(let o=0;o<8;o++){i.globalAlpha=.16;const l=(a()-.5)*n*.035,c=(a()-.5)*r*.05,u=1-a()*.03;i.beginPath();const h=e+l+n*(1-u)/2,f=t+c,p=r*(.97+a()*.05);i.roundRect?i.roundRect(h,f,n*u,p,8+a()*26):i.rect(h,f,n*u,p),i.fill()}for(let o=0;o<60;o++){i.globalAlpha=.05+a()*.07;const l=e+a()*n,u=a()<.5?t+(a()-.6)*26:t+r+(a()-.4)*26;i.beginPath(),i.ellipse(l,u,5+a()*22,3+a()*9,0,0,Math.PI*2),i.fill()}i.globalAlpha=1}function Hg(i,e,t,n){const r=Nl[Math.floor(n()*Nl.length)];i.fillStyle=r.grund,i.fillRect(0,0,e,t);const s=i.createRadialGradient(e/2,t/2,e*.1,e/2,t/2,Math.max(e,t)*.75);s.addColorStop(0,"rgba(255,250,235,0.10)"),s.addColorStop(1,"rgba(30,22,12,0.16)"),i.fillStyle=s,i.fillRect(0,0,e,t);const a=e*.07,o=t*(.3+n()*.24),l=t*.035;Fl(i,a,t*.06,e-a*2,o,r.felder[0],n),Fl(i,a,t*.06+o+l,e-a*2,t*.88-o-l,r.felder[1],n),i.globalAlpha=.5,i.fillStyle=r.glut,i.fillRect(a*1.3,t*.06+o+l*.3,e-a*2.6,l*.42),i.globalAlpha=1;for(let c=0;c<240;c++)i.globalAlpha=.016,i.fillStyle=n()<.5?"#fff6e2":"#241a10",i.fillRect(n()*e,n()*t,12+n()*60,2+n()*5);i.globalAlpha=1}function Ol(i,e,t,n,r,s,a,o,l){const c=n()*Math.PI*2,u={x:a+Math.cos(c)*l*n(),y:o+Math.sin(c)*l*n()},h={x:a+(n()-.5)*l*2.2,y:o+(n()-.5)*l*2.2},f={x:u.x+(n()-.5)*l*1.6,y:u.y+(n()-.5)*l*1.6},p={x:h.x+(n()-.5)*l*1.6,y:h.y+(n()-.5)*l*1.6},_=(E,M,D,A,R)=>(1-E)**3*M+3*(1-E)**2*E*D+3*(1-E)*E*E*A+E**3*R,v=44;i.strokeStyle=r,i.lineCap="round";let m=0,d=0;for(let E=0;E<v;E++){const M=E/v,D=(E+1)/v,A=_(M,u.x,f.x,p.x,h.x),R=_(M,u.y,f.y,p.y,h.y),P=_(D,u.x,f.x,p.x,h.x),y=_(D,u.y,f.y,p.y,h.y),x=Math.sin(Math.min(M*2.4,1)*Math.PI*.5)*(1-M*.55);i.lineWidth=Math.max(1.2,s*x*(.85+n()*.3)),i.globalAlpha=M<.75?.88:.88*(1-(M-.75)*2.6),i.beginPath(),i.moveTo(A,R),i.lineTo(P,y),i.stroke(),m=P-A,d=y-R,E%3===0&&s>10&&(i.globalAlpha=.2,i.lineWidth=1.1,i.beginPath(),i.moveTo(A-d*.14,R+m*.14),i.lineTo(P-d*.14,y+m*.14),i.stroke())}const w=Math.hypot(m,d)||1;for(let E=0;E<5;E++){i.globalAlpha=.35+n()*.3;const M=8+n()*46;i.beginPath(),i.arc(h.x+m/w*M+(n()-.5)*14,h.y+d/w*M+(n()-.5)*14,.8+n()*2.4,0,Math.PI*2),i.fillStyle=r,i.fill()}i.globalAlpha=1}function Wg(i,e,t,n){i.fillStyle="#eae3d1",i.fillRect(0,0,e,t);const r=i.createRadialGradient(e/2,t/2,e*.2,e/2,t/2,Math.max(e,t)*.8);r.addColorStop(0,"rgba(255,252,240,0.06)"),r.addColorStop(1,"rgba(70,55,35,0.09)"),i.fillStyle=r,i.fillRect(0,0,e,t);const s=e*(.38+n()*.24),a=t*(.36+n()*.26),o=Math.min(e,t)*.3;for(let u=0;u<3;u++){const h=s+(n()-.5)*o,f=a+(n()-.5)*o,p=o*(.5+n()*.7),_=i.createRadialGradient(h,f,0,h,f,p);_.addColorStop(0,"rgba(58,54,48,0.055)"),_.addColorStop(.7,"rgba(58,54,48,0.025)"),_.addColorStop(1,"rgba(58,54,48,0)"),i.fillStyle=_,i.fillRect(h-p,f-p,p*2,p*2)}const l=n()<.5?"#a83a22":"#2e4a66",c=5+Math.floor(n()*3);for(let u=0;u<c;u++)Ol(i,e,t,n,"#211f1b",14+n()*n()*44,s,a,o);for(let u=0;u<2;u++)Ol(i,e,t,n,l,8+n()*18,s,a,o*.9)}function Xg(i,e,t){const n=new Array(e).fill(0);n[0]=i(),n[e-1]=i();let r=Math.floor((e-1)/2),s=t;for(;r>=1;){for(let a=r;a<e-1;a+=r*2)n[a]=(n[a-r]+n[a+r])/2+(i()-.5)*s;r=Math.floor(r/2),s*=.55}return n}function qg(i,e,t,n){const r=f=>`rgb(${Math.round(f)},${Math.round(f*.985)},${Math.round(f*.955)})`,s=i.createLinearGradient(0,0,0,t*.75),a=216+n()*22;s.addColorStop(0,r(a)),s.addColorStop(1,r(a*.62)),i.fillStyle=s,i.fillRect(0,0,e,t);const o=e*(.3+n()*.4),l=t*(.16+n()*.18),c=i.createRadialGradient(o,l,4,o,l,e*.42);c.addColorStop(0,"rgba(255,253,246,0.75)"),c.addColorStop(.35,"rgba(255,250,238,0.18)"),c.addColorStop(1,"rgba(255,250,238,0)"),i.fillStyle=c,i.fillRect(0,0,e,t);const u=6;for(let f=0;f<u;f++){const p=f/(u-1),_=t*(.34+p*.52),v=t*(.05+p*.12),m=Xg(n,65,1),d=176-p*128+n()*8,w=i.createLinearGradient(0,_-v,0,t);w.addColorStop(0,r(d)),w.addColorStop(1,r(d*.82)),i.fillStyle=w,i.beginPath(),i.moveTo(0,t);for(let E=0;E<m.length;E++)i.lineTo(e/(m.length-1)*E,_+(m[E]-.5)*v*2);if(i.lineTo(e,t),i.closePath(),i.fill(),f<u-1){const E=i.createLinearGradient(0,_-v*.4,0,_+v);E.addColorStop(0,"rgba(236,233,226,0)"),E.addColorStop(.55,`rgba(236,233,226,${.34-p*.22})`),E.addColorStop(1,"rgba(236,233,226,0)"),i.fillStyle=E,i.fillRect(0,_-v,e,v*2.4)}}const h=i.createRadialGradient(e/2,t/2,Math.min(e,t)*.4,e/2,t/2,Math.max(e,t)*.75);h.addColorStop(0,"rgba(10,9,8,0)"),h.addColorStop(1,"rgba(10,9,8,0.2)"),i.fillStyle=h,i.fillRect(0,0,e,t)}function Yg(i,e,t,n,r){const s=i.getImageData(0,0,e,t),a=s.data;for(let o=0;o<a.length;o+=4){const l=(n()-.5)*r;a[o]+=l,a[o+1]+=l,a[o+2]+=l}i.putImageData(s,0,0)}function jt(i,{srgb:e=!0,wiederholend:t=!1}={}){const n=new rs(i);return e&&(n.colorSpace=Ot),t&&(n.wrapS=n.wrapT=Hi),n}function Uc(i,e,t,n){const r=i.getImageData(0,0,e,t),s=r.data;for(let a=0;a<s.length;a+=4){const o=(Math.random()-.5)*n;s[a]+=o,s[a+1]+=o,s[a+2]+=o}i.putImageData(r,0,0)}function $g(i="#eae3d6"){const t=document.createElement("canvas");t.width=t.height=512;const n=t.getContext("2d");n.fillStyle=i,n.fillRect(0,0,512,512);for(let s=0;s<12;s++){const a=Math.random()*512,o=Math.random()*512,l=80+Math.random()*120,c=n.createRadialGradient(a,o,0,a,o,l);c.addColorStop(0,Math.random()>.5?"rgba(255,252,244,0.02)":"rgba(60,50,38,0.02)"),c.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=c,n.fillRect(a-l,o-l,l*2,l*2)}for(let s=0;s<4e3;s++){const a=.02+Math.random()*.02;n.fillStyle=Math.random()>.5?`rgba(255,255,250,${a})`:`rgba(40,34,26,${a})`,n.fillRect(Math.random()*512,Math.random()*512,1+Math.random()*2,1+Math.random()*2)}const r=n.createLinearGradient(0,0,0,512);return r.addColorStop(0,"rgba(10,8,5,0.08)"),r.addColorStop(.35,"rgba(10,8,5,0)"),r.addColorStop(.8,"rgba(10,8,5,0)"),r.addColorStop(1,"rgba(10,8,5,0.04)"),n.fillStyle=r,n.fillRect(0,0,512,512),t}function Kg(){const t=document.createElement("canvas");t.width=t.height=1024;const n=t.getContext("2d"),r=document.createElement("canvas");r.width=r.height=1024;const s=r.getContext("2d");n.fillStyle="#241708",n.fillRect(0,0,1024,1024),s.fillStyle="#787878",s.fillRect(0,0,1024,1024);const a=["#9a7850","#8d6c47","#83653f","#7d5f3e","#94734c"],o=1024/32;function l(c,u,h,f){const p=a[Math.floor(Math.random()*a.length)];n.fillStyle=p,n.fillRect(c+1,u+1,h-2,f-2),n.fillStyle="rgba(255,238,205,0.10)",n.fillRect(c+1,u+1,h-2,1.5),n.strokeStyle="rgba(46,30,14,0.16)",n.lineWidth=1;const _=h>f,v=5+Math.floor(Math.random()*4);for(let d=0;d<v;d++){if(n.beginPath(),_){const w=u+2+Math.random()*(f-4);n.moveTo(c+2,w);for(let E=c+2;E<c+h-2;E+=16)n.lineTo(E,w+Math.sin(E*.08+d*3)*1.4)}else{const w=c+2+Math.random()*(h-4);n.moveTo(w,u+2);for(let E=u+2;E<u+f-2;E+=16)n.lineTo(w+Math.sin(E*.08+d*3)*1.4,E)}n.stroke()}const m=128+(Math.random()-.5)*60;s.fillStyle=`rgb(${m},${m},${m})`,s.fillRect(c+1,u+1,h-2,f-2)}for(let c=-4;c<o+4;c++)for(let u=-4;u<o+4;u++){const h=((u-c)%8+8)%8;h===0?l(u*32,c*32,128,32):h===7&&l(u*32,c*32,32,128)}return Uc(n,1024,1024,7),{farbe:t,rauheit:r}}function jg(i){const t=document.createElement("canvas");t.width=t.height=256;const n=t.getContext("2d");n.fillStyle=i,n.fillRect(0,0,256,256);for(let r=0;r<40;r++)n.fillStyle=`rgba(0,0,0,${.04+Math.random()*.05})`,n.beginPath(),n.ellipse(Math.random()*256,Math.random()*256,2+Math.random()*5,1+Math.random()*3,Math.random()*3,0,Math.PI*2),n.fill();return Uc(n,256,256,8),t}function Zg(){const i=document.createElement("canvas");i.width=i.height=256;const e=i.getContext("2d");e.save(),e.translate(128,128),e.scale(1,.8);const t=e.createRadialGradient(0,0,8,0,0,126);return t.addColorStop(0,"rgba(255,232,196,0.9)"),t.addColorStop(.5,"rgba(255,228,188,0.35)"),t.addColorStop(1,"rgba(255,228,188,0)"),e.fillStyle=t,e.fillRect(-128,-160,256,320),e.restore(),i}function Jg(){const i=document.createElement("canvas");i.width=256,i.height=128;const e=i.getContext("2d");e.save(),e.translate(128,64),e.scale(1,.5);const t=e.createRadialGradient(0,0,6,0,0,122);return t.addColorStop(0,"rgba(255,226,184,0.85)"),t.addColorStop(1,"rgba(255,226,184,0)"),e.fillStyle=t,e.fillRect(-128,-128,256,256),e.restore(),i}function Qg(){const i=document.createElement("canvas");i.width=64,i.height=256;const e=i.getContext("2d"),t=e.createLinearGradient(0,0,0,256);return t.addColorStop(0,"rgba(255,226,184,0.55)"),t.addColorStop(1,"rgba(255,226,184,0)"),e.fillStyle=t,e.fillRect(0,0,64,256),i}function e0(){const i=document.createElement("canvas");i.width=128,i.height=32;const e=i.getContext("2d"),t=e.createLinearGradient(0,0,0,32);t.addColorStop(0,"rgba(0,0,0,0.30)"),t.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=t,e.fillRect(0,0,128,32);const n=e.createLinearGradient(0,0,14,0);n.addColorStop(0,"rgba(0,0,0,0)"),n.addColorStop(1,"rgba(0,0,0,0)"),e.globalCompositeOperation="destination-in";const r=e.createLinearGradient(0,0,128,0);return r.addColorStop(0,"rgba(0,0,0,0)"),r.addColorStop(.12,"rgba(0,0,0,1)"),r.addColorStop(.88,"rgba(0,0,0,1)"),r.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=r,e.fillRect(0,0,128,32),i}function t0(){const i=document.createElement("canvas");i.width=8,i.height=64;const e=i.getContext("2d"),t=e.createLinearGradient(0,0,0,64);return t.addColorStop(0,"rgba(16,10,4,0.5)"),t.addColorStop(1,"rgba(16,10,4,0)"),e.fillStyle=t,e.fillRect(0,0,8,64),i}function n0(){const i=document.createElement("canvas");i.width=256,i.height=128;const e=i.getContext("2d");e.save(),e.translate(128,64),e.scale(1,.5);const t=e.createRadialGradient(0,0,6,0,0,120);return t.addColorStop(0,"rgba(8,5,2,0.5)"),t.addColorStop(1,"rgba(8,5,2,0)"),e.fillStyle=t,e.fillRect(-128,-128,256,256),e.restore(),i}function i0(i,{schrift:e,farbe:t,buchstabenAbstand:n=0,messing:r=!1}){const s=document.createElement("canvas").getContext("2d");s.font=e;const a=Math.ceil([...i].reduce((h,f)=>h+s.measureText(f).width+n,48)),o=Math.ceil(parseInt(e.match(/(\d+)px/)[1],10)*1.6),l=document.createElement("canvas");l.width=a,l.height=o;const c=l.getContext("2d");if(c.font=e,c.textBaseline="middle",r){const h=c.createLinearGradient(0,0,a,0);h.addColorStop(0,"#a9885a"),h.addColorStop(.5,"#d8bc85"),h.addColorStop(1,"#a9885a"),c.fillStyle=h}else c.fillStyle=t;let u=24;for(const h of i)c.fillText(h,u,o/2),u+=c.measureText(h).width+n;return{canvas:l,breite:a,hoehe:o}}function r0(i){const n=document.createElement("canvas");n.width=800,n.height=1060;const r=n.getContext("2d");r.fillStyle="#f2eee6",r.fillRect(0,0,800,1060);const s=84;r.fillStyle="#8a6d3d",r.font="500 30px Archivo, system-ui, sans-serif";let a=s;for(const o of i.saal.toUpperCase())r.fillText(o,a,138),a+=r.measureText(o).width+9;r.fillStyle="#1d1b18",r.font='400 104px "Cormorant Garamond", Georgia, serif',r.fillText(cs(r,i.name,800-s*2),s-4,268),r.fillStyle="#b59f68",r.fillRect(s,330,120,4),r.fillStyle="#4c473f",r.font="300 40px Archivo, system-ui, sans-serif",s0(r,i.beschreibung,s,432,800-s*2,62),r.strokeStyle="rgba(138,109,61,0.45)",r.lineWidth=2,r.beginPath(),r.moveTo(s,928),r.lineTo(800-s,928),r.stroke(),r.fillStyle="#8a7a5e",r.font='400 34px "Cormorant Garamond", Georgia, serif',a=s;for(const o of(Zt.name||"").toUpperCase())r.fillText(o,a,984),a+=r.measureText(o).width+8;return n}function s0(i,e,t,n,r,s){const a=e.split(" ");let o="";for(const l of a){const c=o?o+" "+l:l;i.measureText(c).width>r&&o?(i.fillText(o,t,n),o=l,n+=s):o=c}o&&i.fillText(o,t,n)}function Bl(i){const e=document.createElement("canvas");e.width=816,e.height=480;const t=e.getContext("2d");t.fillStyle="#f2eee6",t.fillRect(0,0,816,480);const n=52;return t.fillStyle="#b59f68",t.fillRect(n,62,96,5),t.fillStyle="#1d1b18",t.font='500 56px "Cormorant Garamond", Georgia, serif',t.fillText(cs(t,i.titel,816-n*2),n,168),t.font="italic 40px Georgia, serif",t.fillStyle="#4c473f",t.fillText(cs(t,`${i.kuenstler}, ${i.jahr}`,816-n*2),n,240),t.font="34px Georgia, serif",t.fillStyle="#6a645a",t.fillText(cs(t,i.technik,816-n*2),n,302),i.verkauft?(t.fillStyle="#9e3b32",t.beginPath(),t.arc(n+16,386,16,0,Math.PI*2),t.fill(),t.fillStyle="#4c473f",t.font="36px Georgia, serif",t.fillText("Verkauft",n+52,400)):(t.font="500 42px Georgia, serif",t.fillStyle="#8a6d3d",t.fillText(un(i.preis),n,400)),e}function cs(i,e,t){if(i.measureText(e).width<=t)return e;let n=e;for(;n.length>3&&i.measureText(n+"…").width>t;)n=n.slice(0,-1);return n+"…"}class a0 extends xc{constructor(){super();const e=new xt;e.deleteAttribute("uv");const t=new yt({side:zt}),n=new yt,r=new Uh(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);const s=new Ie(e,t);s.position.set(-.757,13.219,.717),s.scale.set(31.713,28.305,28.591),this.add(s);const a=new _h(e,n,6),o=new Tt;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);const l=new Ie(e,Pi(50));l.position.set(-16.116,14.37,8.208),l.scale.set(.1,2.428,2.739),this.add(l);const c=new Ie(e,Pi(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);const u=new Ie(e,Pi(17));u.position.set(14.904,12.198,-1.832),u.scale.set(.15,4.265,6.331),this.add(u);const h=new Ie(e,Pi(43));h.position.set(-.462,8.89,14.52),h.scale.set(4.38,5.441,.088),this.add(h);const f=new Ie(e,Pi(20));f.position.set(3.235,11.486,-12.541),f.scale.set(2.5,2,.1),this.add(f);const p=new Ie(e,Pi(100));p.position.set(0,20,0),p.scale.set(1,.1,1),this.add(p)}dispose(){const e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(const t of e)t.dispose()}}function Pi(i){const e=new gt;return e.color.setScalar(i),e}function o0(i,e,t,n){try{const c=new Wa(e);i.environment=c.fromScene(new a0,.04).texture,i.environmentIntensity=.25}catch(c){console.warn("Environment-Reflexe nicht verfügbar:",c)}i.add(new Ph(15985369,920585,ze.licht.grundlicht)),t.forEach((c,u)=>{const h=ze.saalStile[c.id]||ze.saalStile.standard,f=new Dh(h.spotFarbe,ze.licht.saalSpot*h.lichtFaktor,ze.raum.breite*1.6,.95,.85,2);f.position.set(n(u),ze.raum.hoehe-.15,0),f.target.position.set(n(u),0,0),i.add(f),i.add(f.target)});const r=[];let s=null;function a(c,u,h=0){c.opacity=u*.3,r.push({material:c,ziel:u,verzoegerung:h*.12})}function o(){s=performance.now()}function l(){if(s===null)return;const c=(performance.now()-s)/1e3;let u=!0;for(const h of r){const f=(c-h.verzoegerung)/.8;if(f<0){u=!1;continue}const p=Math.min(f,1),_=p*p*(3-2*p);let v=h.ziel*(.3+.7*_);p<.375&&(v*=1+(Math.random()-.5)*.08),h.material.opacity=v,p<1&&(u=!1)}if(u){for(const h of r)h.material.opacity=h.ziel;s=null}}return{registriere:a,zuendeLichter:o,update:l}}const zl=ze.raum.hoehe;let ea=null,ta=null;function l0(){return ea||(ea=jt(Qg())),ea}function Nc(){return ta||(ta=jt(n0())),ta}const kl=new yt({color:1775894,roughness:.4,metalness:.6});function Ya(i,e,t,n,r,s){const o=e.x+t.x*.85,l=e.z+t.z*.85,c=zl-.12,u=new Sn,h=new Ie(new xt(.6,.03,.06),kl);h.position.set(o,zl-.015,l),h.rotation.y=Math.atan2(t.x,t.z),u.add(h);const f=new Ie(new ds(.045,.05,.12,16),kl);f.position.set(o,c,l);const p=new U(e.x-o,e.y-c,e.z-l),_=p.length(),v=p.clone().normalize();f.quaternion.setFromUnitVectors(new U(0,-1,0),v),u.add(f);const m=new Ie(new po(.032,16),new gt({color:16771529}));m.position.set(o+v.x*.065,c+v.y*.065,l+v.z*.065),m.quaternion.setFromUnitVectors(new U(0,0,1),v),u.add(m);const d=new ds(.03,Math.max(n*.75,.5),_,20,1,!0),w=new gt({map:l0(),color:16769720,transparent:!0,opacity:ze.licht.kegelDeckkraft,blending:li,depthWrite:!1,side:Nn}),E=new Ie(d,w);return E.position.set(o+p.x/2,c+p.y/2,l+p.z/2),E.quaternion.setFromUnitVectors(new U(0,-1,0),v),u.add(E),r(w,ze.licht.kegelDeckkraft,s),i.add(u),u}function c0(i,e,t,n){const r=new Sn,s=jt(jg("#"+n.toString(16).padStart(6,"0"))),a=new Ie(new xt(1.6,.075,.46),new yt({map:s,roughness:.88,envMapIntensity:.12}));a.position.y=.45,r.add(a);const o=new yt({color:1905932,roughness:.75,envMapIntensity:.15});for(const c of[-.68,.68]){const u=new Ie(new xt(.07,.41,.44),o);u.position.set(c,.205,0),r.add(u)}const l=new Ie(new vt(2.3,.95),new gt({map:Nc(),transparent:!0,depthWrite:!1,opacity:.55}));return l.rotation.x=-Math.PI/2,l.position.y=.005,r.add(l),r.position.set(e,0,t),i.add(r),{minX:e-1,maxX:e+1,minZ:t-.42,maxZ:t+.42}}function u0(i,e,t,n,r,s){const a=new Sn,o=new Ie(new xt(.45,1.1,.45),n);o.position.y=.55,a.add(o);const l=new Ie(new go(.14,.045,128,20),new yt({color:12755819,metalness:.95,roughness:.25,envMapIntensity:1.3}));l.position.y=1.32,a.add(l);const c=new Ie(new vt(1.2,.9),new gt({map:Nc(),transparent:!0,depthWrite:!1,opacity:.5}));return c.rotation.x=-Math.PI/2,c.position.y=.005,a.add(c),a.position.set(e,0,t),i.add(a),Ya(i,new U(e,1.32,t),new U(.35,0,.35).normalize(),.5,r,s),{objekt:l,zone:{minX:e-.55,maxX:e+.55,minZ:t-.55,maxZ:t+.55}}}function Gl(i,e,t,n,r){const s=new Sn;s.position.set(t,1.5,n),s.rotation.y=r;const a=new Ie(new xt(.63,.835,.014),new yt({color:15920870,roughness:.55}));s.add(a);const o=jt(r0(e));o.anisotropy=8;const l=new Ie(new vt(.62,.821),new gt({map:o}));return l.position.z=.0075,s.add(l),i.add(s),s}function jr(i,e,{x:t,y:n,z:r,ry:s,hoeheM:a,farbe:o,messing:l=!1,schrift:c}){const{canvas:u,breite:h,hoehe:f}=i0(e,{schrift:c||"500 128px Archivo, system-ui, sans-serif",farbe:o||"rgba(43,39,33,0.85)",buchstabenAbstand:36,messing:l}),p=jt(u);p.anisotropy=8;const _=a/f,v=new Ie(new vt(h*_,f*_),new gt({map:p,transparent:!0,depthWrite:!1}));return v.position.set(t,n,r),v.rotation.y=s,i.add(v),v}const Rt=ze.raum.breite,ot=ze.raum.tiefe,Et=ze.raum.hoehe,$e=ze.raum.wandstaerke,Rn=ze.raum.tuerBreite,mn=ze.raum.tuerHoehe,Vl=ze.besucher.augenhoehe;function Ft(i){return i*(Rt+$e)}function cr(i){return ze.saalStile[i.id]||ze.saalStile.standard}function h0(i){return"#"+i.toString(16).padStart(6,"0")}const Fc=Pc?ze.mobil.dprCapSchwach:kt?ze.mobil.dprCap:1.75;function f0(i){const e=new Mg({canvas:i,antialias:Fi==="A"?!1:window.devicePixelRatio<2,powerPreference:kt?"default":"high-performance"});e.setPixelRatio(Math.min(window.devicePixelRatio,Fc)),e.setSize(window.innerWidth,window.innerHeight),e.toneMapping=Qa,e.toneMappingExposure=ze.licht.belichtungIntro;const t=new xc;t.background=new We(394500),t.fog=new ho(394500,26,72);const n=new Ht(ze.besucher.fovBasis,window.innerWidth/window.innerHeight,.05,120);n.rotation.order="YXZ",n.position.set(Ft(0)-Rt/2+2.3,Vl,0),n.rotation.y=-Math.PI/2;const r=ht.length,s=r*Rt+(r-1)*$e,a=-Rt/2-$e,o=a+s+2*$e,l=(a+o)/2,c=o0(t,e,ht,Ft);let u=0;const h=Kg(),f=kt?4:e.capabilities.getMaxAnisotropy(),p=jt(h.farbe,{wiederholend:!0});p.repeat.set(s/3,ot/3),p.anisotropy=f;const _=new rs(h.rauheit);_.wrapS=_.wrapT=Hi,_.repeat.copy(p.repeat);const v=Fi==="A"?new yh({map:p,roughnessMap:_,roughness:.65,clearcoat:.15,clearcoatRoughness:.6,envMapIntensity:.35}):new yt({map:p,roughnessMap:_,roughness:.65,envMapIntensity:.35}),m=new Ie(new vt(s+2*$e,ot+2*$e),v);m.rotation.x=-Math.PI/2,m.position.set(l,0,0),m.name="boden",t.add(m);const d=jt(t0());function w(H,W,T,Re){const ve=new Ie(new vt(H,.55),new gt({map:d,transparent:!0,depthWrite:!1,opacity:.65}));ve.rotation.set(-Math.PI/2,0,Re),ve.position.set(W,.004,T),t.add(ve)}w(s,l,-ot/2+.275,0),w(s,l,ot/2-.275,Math.PI),w(ot,a+$e+.275,0,Math.PI/2),w(ot,o-$e-.275,0,-Math.PI/2);const E=new Ie(new vt(s+2*$e,ot+2*$e),new yt({color:1315085,roughness:.95}));E.rotation.x=Math.PI/2,E.position.set(l,Et,0),t.add(E);const M=ht.map(H=>{const W=cr(H),T=jt($g(h0(W.wand)));return T.wrapS=Hi,T.wrapT=Xn,T.repeat.set(Rt/2.4,1),new yt({map:T,roughness:.94,envMapIntensity:.15})}),D=new yt({color:2368030,roughness:.45,metalness:.1}),A=new gt({color:657672}),R=[];function P(H,W,T,Re,ve,me,Q){const Oe=new Ie(new xt(W,T,Re),H);return Oe.position.set(ve,me,Q),t.add(Oe),R.push(Oe),Oe}const y=new gt({color:3746841});function x(H,W,T,Re){const ve=new Ie(new xt(H,.11,.035),D);ve.rotation.y=Re,ve.position.set(W,.055,T),t.add(ve);const me=new Ie(new xt(H,.02,.037),A);me.rotation.y=Re,me.position.set(W,.12,T),t.add(me);const Q=new Ie(new xt(H,.035,.03),y);Q.rotation.y=Re,Q.position.set(W,Et-.06,T),t.add(Q)}ht.forEach((H,W)=>{const T=Ft(W),Re=W===0?a:T-Rt/2-$e/2,ve=W===r-1?o:T+Rt/2+$e/2,me=ve-Re,Q=(Re+ve)/2;P(M[W],me,Et,$e,Q,Et/2,-ot/2-$e/2),P(M[W],me,Et,$e,Q,Et/2,ot/2+$e/2),x(me,Q,-ot/2+.02,0),x(me,Q,ot/2-.02,0)}),P(M[0],$e,Et,ot,a+$e/2,Et/2,0),P(M[r-1],$e,Et,ot,o-$e/2,Et/2,0),x(ot,a+$e+.02,0,Math.PI/2),x(ot,o-$e-.02,0,Math.PI/2),jr(t,Zt.name.toUpperCase(),{x:a+$e+.02,y:2.15,z:0,ry:Math.PI/2,hoeheM:.5,messing:!0,schrift:'300 120px "Cormorant Garamond", Georgia, serif'}),jr(t,"VIRTUELLER SHOWROOM",{x:a+$e+.02,y:1.62,z:0,ry:Math.PI/2,hoeheM:.09,farbe:"rgba(150,136,112,0.9)"}),Ya(t,new U(a+$e,2,0),new U(1,0,0),2.4,c.registriere,u++);const C=new yt({color:2762013,roughness:.4,metalness:.15});for(let H=0;H<r-1;H++){const W=Ft(H)+Rt/2+$e/2,T=(ot-Rn)/2;for(const[me,Q]of[[M[H],-$e/4],[M[H+1],$e/4]])P(me,$e/2,Et,T,W+Q,Et/2,-ot/2+T/2),P(me,$e/2,Et,T,W+Q,Et/2,ot/2-T/2),P(me,$e/2,Et-mn,Rn,W+Q,mn+(Et-mn)/2,0);for(const me of[-1,1])x(T,W+me*($e/2+.015),-ot/2+T/2,Math.PI/2),x(T,W+me*($e/2+.015),ot/2-T/2,Math.PI/2);for(const me of[-Rn/2,Rn/2]){const Q=new Ie(new xt($e+.07,mn,.09),C);Q.position.set(W,mn/2,me),t.add(Q)}const Re=new Ie(new xt($e+.07,.09,Rn+.09),C);Re.position.set(W,mn+.045,0),t.add(Re);const ve=new Ie(new xt($e+.1,.012,Rn),new yt({color:12755819,metalness:.85,roughness:.3,envMapIntensity:1}));ve.position.set(W,.006,0),t.add(ve),jr(t,`${ht[H+1].saal} — ${ht[H+1].name}`.toUpperCase(),{x:W-$e/2-.012,y:mn+(Et-mn)/2,z:0,ry:-Math.PI/2,hoeheM:.14,farbe:Hl(cr(ht[H]).lettering,.85)}),jr(t,`${ht[H].saal} — ${ht[H].name}`.toUpperCase(),{x:W+$e/2+.012,y:mn+(Et-mn)/2,z:0,ry:Math.PI/2,hoeheM:.14,farbe:Hl(cr(ht[H+1]).lettering,.85)}),Gl(t,ht[H+1],W+$e/2+.012,-Rn/2-.85,Math.PI/2)}Gl(t,ht[0],Ft(0)-Rt/2+1.05,ot/2-.012,Math.PI);const z=[];if(ht.forEach((H,W)=>{z.push(c0(t,Ft(W),.95,cr(H).bank))}),r>1){const H=u0(t,Ft(1)+4.5,-2.5,M[1],c.registriere,u++);z.push(H.zone);var B=H.objekt}const q=new Map,Z=[],Y=jt(Zg()),re=jt(Jg()),K=jt(e0());ht.forEach((H,W)=>{const T=Ft(W),Re=cr(H),ve=ze.haengung.plaetzeLaengswand,me=ze.haengung.plaetzeStirnwand,Q=[{slots:ve,laenge:Rt-2.5,ry:0,basis:new U(T,0,-ot/2),achse:"x"},{slots:ve,laenge:Rt-2.5,ry:Math.PI,basis:new U(T,0,ot/2),achse:"x"}];W===r-1&&Q.push({slots:me,laenge:ot-2.5,ry:-Math.PI/2,basis:new U(T+Rt/2,0,0),achse:"z"});const Oe=ls(H.id),we=Q.reduce((b,g)=>b+g.slots,0);Oe.length>we&&console.warn(`Raum "${H.name}": ${Oe.length} Werke, aber nur ${we} Plätze — überzählige Werke werden nicht gehängt.`);const Te=Q.map(()=>[]);let Qe=0;for(const b of Oe.slice(0,we)){let g=0;for(;Te[Qe].length>=Q[Qe].slots&&g<Q.length;)Qe=(Qe+1)%Q.length,g++;Te[Qe].push(b),Qe=(Qe+1)%Q.length}Q.forEach((b,g)=>{const L=Te[g].length;Te[g].forEach((O,$)=>{const _e=(($+1)/(L+1)-.5)*b.laenge,le=b.basis.clone();b.achse==="x"?le.x+=_e:le.z+=_e,ae(O,H,Re,le,b.ry)})})});function ae(H,W,T,Re,ve){const me=H.breite_cm/100,Q=H.hoehe_cm/100,Oe=W.id==="fotografie",we=Vl+Q*.05,Te=new Sn;Te.position.copy(Re),Te.position.y=we,Te.rotation.y=ve,t.add(Te);const Qe=new gt({map:Y,transparent:!0,opacity:ze.licht.poolWand*T.poolFaktor,blending:li,depthWrite:!1}),b=new Ie(new vt(me*2.2,Q*1.9),Qe);b.position.set(0,Q*.1,.004),Te.add(b),c.registriere(Qe,ze.licht.poolWand*T.poolFaktor,u);const g=new gt({map:K,transparent:!0,opacity:ze.licht.schattenRahmen,depthWrite:!1}),L=new Ie(new vt(me*1.06+.16,.22),g);L.position.set(0,-(Q/2)-.19,.005),Te.add(L);const O=new gt({map:re,transparent:!0,opacity:ze.licht.poolBoden*T.poolFaktor,blending:li,depthWrite:!1}),$=new Ie(new vt(me*1.7+.4,1.1),O);$.rotation.x=-Math.PI/2,$.position.set(0,-we+.006,.75),Te.add($),c.registriere(O,ze.licht.poolBoden*T.poolFaktor,u);const k=Lc(H);let _e;k.typ==="canvas"?_e=new rs(k.wert):_e=new Ch().load(k.wert,void 0,void 0,()=>{console.warn(`Werkfoto „${k.wert}" nicht ladbar — Platzhalter aktiv (${H.id}).`);const ue=new rs(Dc(H));ue.colorSpace=Ot,ue.anisotropy=f,de.material.map=ue,de.material.needsUpdate=!0}),_e.colorSpace=Ot,_e.anisotropy=f;function le(ue,te,ge,ie,ee,Ce){const ke=new Sn,rt=new Ie(new xt(ue+ge*2,ge,ie),ee);rt.position.set(0,te/2+ge/2,0);const nt=rt.clone();nt.position.y=-(te/2+ge/2);const Dt=new Ie(new xt(ge,te,ie),ee);Dt.position.set(-(ue/2+ge/2),0,0);const Qt=Dt.clone();return Qt.position.x=ue/2+ge/2,ke.add(rt,nt,Dt,Qt),ke.position.z=Ce,Te.add(ke),ke}let de,be;if(Oe){be=me+.09*2+.056;const te=new yt({color:1776152,roughness:.35,metalness:.3});le(me+.09*2,Q+.09*2,.028,.045,te,.028);const ge=new Ie(new vt(me+.09*2,Q+.09*2),new yt({color:16052713,roughness:.9}));if(ge.position.z=.03,Te.add(ge),de=new Ie(new vt(me,Q),new gt({map:_e})),de.position.z=.033,Te.add(de),Fi==="A"){const ie=new Ie(new vt(me+.18,Q+.18),new yt({color:0,transparent:!0,opacity:.05,roughness:.05,metalness:1,envMapIntensity:1.2,depthWrite:!1}));ie.position.z=.048,Te.add(ie)}}else{be=me+.16;const ue=new yt({color:3023128,roughness:.4,metalness:.1}),te=new yt({color:12755819,metalness:.9,roughness:.3,envMapIntensity:1});le(me+.03,Q+.03,.065,.06,ue,.032),le(me,Q,.016,.052,te,.04);const ge=new Ie(new vt(me+.04,Q+.04),new gt({color:1183241}));ge.position.z=.012,Te.add(ge),de=new Ie(new vt(me,Q),new gt({map:_e})),de.position.z=.024,Te.add(de)}de.userData={werkId:H.id,breite:me,hoehe:Q};const J=new Ie(new vt(be,Q+.2),new gt({transparent:!0,opacity:0,depthWrite:!1}));J.position.z=.09,J.userData={werkId:H.id,breite:me,hoehe:Q},Te.add(J),Z.push(de,J);const Me=be/2+.18+.17,fe=1.45-.1-we,Ee=new Ie(new xt(.345,.205,.006),new yt({color:15920870,roughness:.5}));Ee.position.set(Me,fe,.008),Te.add(Ee);const oe=jt(Bl(H));oe.anisotropy=f;const Ue=new Ie(new vt(.34,.2),new gt({map:oe}));Ue.position.set(Me,fe,.012),Ue.userData={werkId:H.id,istPlakette:!0},Te.add(Ue),Z.push(Ue);const I=new U(0,0,1).applyEuler(new pn(0,ve,0));Ya(t,new U(Re.x,we,Re.z),I,me,c.registriere,u),u++,q.set(H.id,{gruppe:Te,flaeche:de,normal:I,plakette:Ue,werk:H,raum:W,inselMat:Qe,inselBasis:ze.licht.poolWand*T.poolFaktor})}let he=null;function Pe(H){he=H}function Ve(H){const W=1-Math.exp(-8*H);for(const[T,Re]of q){const ve=T===he?Math.min(1,Re.inselBasis*1.4):Re.inselBasis;Math.abs(Re.inselMat.opacity-ve)>.003&&(Re.inselMat.opacity+=(ve-Re.inselMat.opacity)*W)}}const j=(Fi==="A"?110:55)*r,ce=new Wt,Se=new Float32Array(j*3);for(let H=0;H<j;H++){const W=H%r;Se[H*3]=Ft(W)+(Math.random()-.5)*Rt*.8,Se[H*3+1]=.5+Math.random()*(Et-1.1),Se[H*3+2]=(Math.random()-.5)*ot*.7}ce.setAttribute("position",new an(Se,3));const pe=new Sh(ce,new Mc({color:16771528,size:.016,transparent:!0,opacity:.17,blending:li,depthWrite:!1}));t.add(pe);function De(H,W){if(Ni)return;const T=ce.attributes.position;for(let Re=0;Re<j;Re++){let ve=T.getY(Re)-H*.02;ve<.4&&(ve=Et-.7),T.setY(Re,ve),T.setX(Re,T.getX(Re)+Math.sin(W*.3+Re)*4e-4)}T.needsUpdate=!0}function je(H){const W=q.get(H);if(!W)return;W.werk.verkauft=!0,W.plakette.material.map?.dispose();const T=jt(Bl(W.werk));T.anisotropy=f,W.plakette.material.map=T,W.plakette.material.needsUpdate=!0}const G=[];for(let H=0;H<r;H++){const W=Ft(H);G.push({minX:W-Rt/2+.55,maxX:W+Rt/2-.55,minZ:-ot/2+.55,maxZ:ot/2-.55}),H<r-1&&G.push({minX:W+Rt/2-.6,maxX:Ft(H+1)-Rt/2+.6,minZ:-Rn/2+.35,maxZ:Rn/2-.35})}const ne={ziel:ze.licht.belichtungIntro};return{renderer:e,scene:t,camera:n,boden:m,klickbare:Z,hindernisse:R,kunstwerke:q,erlaubt:G,verboten:z,aktualisiereVerkauft:je,belichtung:ne,beleuchtung:c,podestObjekt:B,setzeHover:Pe,updateHover:Ve,updateStaub:De}}function Hl(i,e){const t=i.replace("#",""),n=parseInt(t.slice(0,2),16),r=parseInt(t.slice(2,4),16),s=parseInt(t.slice(4,6),16);return`rgba(${n},${r},${s},${e})`}function d0(i){const e=ze.mobil.joystickRadiusPx,t=ze.mobil.joystickDeadzone,n=document.createElement("div");n.id="joystick",n.innerHTML='<div class="joy-nub"></div>',document.body.appendChild(n);const r=n.firstElementChild;let s=null,a=0,o=0;function l(u){let h=u.clientX-a,f=u.clientY-o;const p=Math.hypot(h,f);p>e&&(h*=e/p,f*=e/p),r.style.transform=`translate(calc(-50% + ${h}px), calc(-50% + ${f}px))`;const _=h/e,v=f/e,m=Math.hypot(_,v);if(m<t){i.x=0,i.y=0;return}const d=(m-t)/(1-t)/m;i.x=_*d,i.y=v*d}function c(){s=null,i.x=0,i.y=0,r.style.transform="translate(-50%, -50%)",n.classList.remove("greift")}return n.addEventListener("pointerdown",u=>{if(s!==null)return;s=u.pointerId;const h=n.getBoundingClientRect();a=h.left+h.width/2,o=h.top+h.height/2,n.setPointerCapture(s),n.classList.add("greift"),l(u),u.preventDefault()}),n.addEventListener("pointermove",u=>{u.pointerId===s&&l(u)}),n.addEventListener("pointerup",u=>{u.pointerId===s&&c()}),n.addEventListener("pointercancel",u=>{u.pointerId===s&&c()}),{zeige(u){n.classList.toggle("aktiv",u),u||c()}}}const _t=ze.besucher,p0=kt?ze.mobil.tapToleranzPx:9;function m0({camera:i,dom:e,scene:t,boden:n,klickbare:r,hindernisse:s=[],kunstwerke:a,erlaubt:o,verboten:l,callbacks:c}){let u=!1,h=null,f=null,p=null,_=0,v=0,m=0,d=0,w=0,E=0;i.rotation.set(0,0,0);const M=new Be,D={x:0,y:0};let A=null,R=0,P=0,y=!1,x=!1,C=null;const z=new Set,B=new Fh,q=new Be,Z=new Ie(new mo(.13,.17,40),new gt({color:12755819,transparent:!0,opacity:0,depthWrite:!1}));Z.rotation.x=-Math.PI/2,Z.position.y=.012,t.add(Z);let Y=99;function re(g,L){return l.some(O=>g>=O.minX&&g<=O.maxX&&L>=O.minZ&&L<=O.maxZ)?!1:o.some(O=>g>=O.minX&&g<=O.maxX&&L>=O.minZ&&L<=O.maxZ)}function K(g,L){const O=i.position;let $=!1,k=!1;return re(O.x+g,O.z)?O.x+=g:$=!0,re(O.x,O.z+L)?O.z+=L:k=!0,{bx:$,bz:k}}let ae=null,he=0,Pe=0,Ve=0,Ke=0,j=0;e.addEventListener("pointerdown",g=>{u&&ae===null&&(ae=g.pointerId,he=0,j=0,Pe=g.clientX,Ve=g.clientY,Ke=performance.now(),e.setPointerCapture(g.pointerId),E=0)}),e.addEventListener("pointermove",g=>{if(!u)return;if(g.pointerId!==ae){kt||De(g.clientX,g.clientY);return}const L=g.clientX-Pe,O=g.clientY-Ve;Pe=g.clientX,Ve=g.clientY,he+=Math.abs(L)+Math.abs(O),!h&&(d-=L*_t.drehempfindlichkeit,w=Vt.clamp(w-O*_t.drehempfindlichkeit,-1.15,1.15),j=L)}),e.addEventListener("pointerup",g=>{if(!u||g.pointerId!==ae)return;ae=null,!h&&Math.abs(j)>2&&(E=Vt.clamp(-j*_t.drehempfindlichkeit*40,-1.5,1.5)),he<p0&&performance.now()-Ke<500&&je(g.clientX,g.clientY)}),e.addEventListener("pointercancel",g=>{g.pointerId===ae&&(ae=null)});function ce(g){const L=g.target;return L&&(L.tagName==="INPUT"||L.tagName==="TEXTAREA"||L.isContentEditable)}window.addEventListener("keydown",g=>{g.repeat||ce(g)||z.add(g.code)}),window.addEventListener("keyup",g=>z.delete(g.code)),window.addEventListener("blur",()=>z.clear());function Se(g,L){q.x=g/window.innerWidth*2-1,q.y=-(L/window.innerHeight)*2+1,B.setFromCamera(q,i);const O=s.length?B.intersectObjects(s,!1):[],$=O.length?O[0].distance:1/0,k=B.intersectObjects(r,!1);if(k.length&&k[0].distance<14&&k[0].distance<$)return{typ:"werk",hit:k[0]};const _e=B.intersectObject(n,!1);return _e.length&&_e[0].distance<$?{typ:"boden",hit:_e[0]}:null}let pe=null;function De(g,L){const O=Se(g,L),$=O&&O.typ==="werk"?O.hit.object.userData.werkId:null;$!==pe&&(pe=$,e.classList.toggle("hover-art",!!$)),c.hover($,g,L)}function je(g,L){const O=Se(g,L);O&&(O.typ==="werk"?G(O.hit.object.userData.werkId):h||(A=new U(O.hit.point.x,0,O.hit.point.z),Z.position.set(A.x,.012,A.z),Y=0))}function G(g){const L=a.get(g);if(!L||!u)return!1;const O=we(L.gruppe.position.x);if(O!==Te()&&!C)return c.saalwechsel(O,()=>{me(O),G(g)}),!0;if(h===g&&!C&&f){const Ee=new U;L.flaeche.getWorldPosition(Ee);const oe=i.position.distanceTo(Ee),Ue=Ee.clone().addScaledVector(L.normal,Math.max(oe*.5,.95));return Ue.y=i.position.y,C={t:0,dauer:Ni?.15:.6,p0:i.position.clone(),p1:i.position.clone().lerp(Ue,.5),p2:Ue,vonYaw:v,nachYaw:v,vonPitch:m,nachPitch:m},f=Ue.clone(),!0}h=g,A=null,M.set(0,0),E=0;const $=new U;L.flaeche.getWorldPosition($);const k=Math.max(L.flaeche.userData.breite||1,L.flaeche.userData.hoehe||1),_e=i.aspect<1?1.3:1,le=Vt.clamp(k*1.35*_e,1.5,4.2),de=$.clone().addScaledVector(L.normal,le);de.y=_t.augenhoehe;const be=i.position.clone().add(de).multiplyScalar(.5),J=new U(-L.normal.z,0,L.normal.x),Me=new U(Ft(Te()),_t.augenhoehe,0);be.clone().add(J).distanceTo(Me)>be.clone().sub(J).distanceTo(Me)&&J.negate(),be.addScaledVector(J,.35);const fe=$.clone().sub(de).normalize();return C={t:0,dauer:Ni?.3:1.6,p0:i.position.clone(),p1:be,p2:de,vonYaw:v,nachYaw:ne(v,Math.atan2(-fe.x,-fe.z)),vonPitch:m,nachPitch:Math.asin(Vt.clamp(fe.y,-1,1))},f=de.clone(),p=J.clone(),_=0,c.werkGewaehlt(g),c.fokusKlang?.(),!0}function ne(g,L){let O=(L-g)%(Math.PI*2);return O>Math.PI&&(O-=Math.PI*2),O<-Math.PI&&(O+=Math.PI*2),g+O}function H(){h=null,f=null,C=null}let W=!1;function T(g){W=g,Re()}function Re(){const g=window.innerWidth,L=window.innerHeight;W&&os()?i.setViewOffset(g,L,0,L*.24,g,L):W&&g>=900?i.setViewOffset(g,L,208,0,g,L):i.clearViewOffset(),i.updateProjectionMatrix()}function ve(g){g===Te()&&!h||c.saalwechsel(g,()=>me(g))}function me(g){h&&c.schliessePanel(),H(),A=null,M.set(0,0),E=0,i.position.set(Ft(g),_t.augenhoehe,ot*.3),v=d=0,m=w=0,i.rotation.set(0,0,0)}let Q=0;function Oe(g){if(!u)return;E!==0&&(d+=E*g,E*=Math.exp(-5*g),Math.abs(E)<.01&&(E=0));const L=1-Math.exp(-13*g);if(v+=(d-v)*L,m+=(w-m)*L,C){C.t+=g/C.dauer;const fe=Math.min(C.t,1),Ee=fe<.5?16*fe**5:1-Math.pow(-2*fe+2,5)/2;i.position.lerpVectors(C.p0.clone().lerp(C.p1,Ee),C.p1.clone().lerp(C.p2,Ee),Ee),v=d=Vt.lerp(C.vonYaw,C.nachYaw,Ee),m=w=Vt.lerp(C.vonPitch,C.nachPitch,Ee),i.rotation.set(m,v,0),C.t>=1&&(C=null),P=0;return}if(h){f&&!Ni&&(_+=g,i.position.copy(f).addScaledVector(p,Math.sin(_*.28)*.012)),i.rotation.set(m,v,0),P=0;return}const O=new Be;let $=0,k=0;(z.has("KeyW")||z.has("ArrowUp"))&&($+=1),(z.has("KeyS")||z.has("ArrowDown"))&&($-=1),(z.has("KeyA")||z.has("ArrowLeft"))&&(k-=1),(z.has("KeyD")||z.has("ArrowRight"))&&(k+=1),!$&&!k&&(D.x||D.y)&&($=-D.y,k=D.x);let _e=_t.gehtempo;const le=Math.min(1,Math.hypot($,k));if(le>0){A=null;const fe=1/Math.hypot($,k),Ee=Math.sin(v),oe=Math.cos(v);O.set((-Ee*$+oe*k)*fe*le,(-oe*$-Ee*k)*fe*le)}else if(A){const fe=A.x-i.position.x,Ee=A.z-i.position.z,oe=Math.hypot(fe,Ee);oe<.25?A=null:(oe<1&&(_e=Vt.lerp(.6,_t.gehtempo,oe)),O.set(fe/oe*(_e/_t.gehtempo),Ee/oe*(_e/_t.gehtempo)))}O.multiplyScalar(_t.gehtempo);const de=1-Math.exp(-15*g),be=1-Math.exp(-6.5*g);if(M.lerp(O,O.lengthSq()>0?de:be),M.lengthSq()>1e-6){const fe=K(M.x*g,M.y*g);fe.bx&&(M.x=0),fe.bz&&(M.y=0),fe.bx&&fe.bz&&(A=null)}P=M.length()/_t.gehtempo;let J=0,Me=0;if(!Ni&&P>.02){R+=Math.PI*2*_t.bobFrequenz*P*g;const fe=Math.sin(R);J=fe*_t.bobAmplitude*P,Me=Math.sin(R*.5)*_t.bobRolle*P,fe>.2&&(y=!0),y&&fe<-.85&&P>.25&&(y=!1,x=!x,c.schritt?.(x,P))}if(i.position.y=_t.augenhoehe+J,i.rotation.set(m,v,Me),kt&&(Q+=g,Q>=.16)){Q=0;const fe=Se(window.innerWidth/2,window.innerHeight/2),Ee=fe&&fe.typ==="werk"&&fe.hit.distance<6.5?fe.hit.object.userData.werkId:null;Ee!==pe&&(pe=Ee,c.hover(Ee,0,0))}if(Y+=g,A){const fe=1+Math.sin(Y*6)*.06;Z.scale.setScalar(Math.max(1.5-Y*2.5,1)*fe),Z.material.opacity=Math.min(Y*5,.85)}else Z.material.opacity=Math.max(Z.material.opacity-g*3,0)}function we(g){let L=0,O=1/0;for(let $=0;$<ht.length;$++){const k=Math.abs(g-Ft($));k<O&&(O=k,L=$)}return L}function Te(){return we(i.position.x)}function Qe(){if(i.aspect>=1)return _t.fovBasis;const g=Vt.degToRad(ze.mobil.hFovZielGrad),L=2*Math.atan(Math.tan(g/2)/i.aspect);return Vt.clamp(Vt.radToDeg(L),_t.fovBasis,80)}function b(){const g=Qe();return h?i.aspect<1?g-10:_t.fovFokus:g+(_t.fovGehen-_t.fovBasis)*Math.min(P,1)}return{update:Oe,fokussiere:G,fokusVerlassen:H,zuRaum:ve,teleportiere:me,aktuellerRaum:Te,fovZiel:b,joy:D,setzeSheetOffset:T,wendeSheetOffsetAn:Re,tempo:()=>P,imFokus:()=>!!h,starte(){u=!0},setzeBlick(g,L){v=d=g,m=w=L,i.rotation.set(m,v,0)}}}const Oc="galerie-jp-stumm";let et=null,ai=null,Wn=null,Zr=null,fr=null,ii=null,Ii=null,$i=!1,vn=localStorage.getItem(Oc)==="1";function hi(){return et.currentTime}function Wl(){return vn}function g0(){return vn=!vn,localStorage.setItem(Oc,vn?"1":"0"),ai&&ai.gain.setTargetAtTime(vn?0:ze.klang.master,hi(),.1),vn}function _0(){if($i){et?.resume();return}$i=!0,et=new(window.AudioContext||window.webkitAudioContext),ai=et.createGain(),ai.gain.value=vn?0:ze.klang.master,ai.connect(et.destination),Wn=et.createGain(),Wn.gain.value=1,Wn.connect(ai),fr=et.createConvolver();const i=2.2,e=et.sampleRate,t=et.createBuffer(2,i*e,e);for(let u=0;u<2;u++){const h=t.getChannelData(u);for(let f=0;f<h.length;f++)h[f]=(Math.random()*2-1)*Math.pow(1-f/h.length,2.8)}fr.buffer=t,Zr=et.createGain(),Zr.gain.value=ze.klang.hallAnteil,fr.connect(Zr),Zr.connect(ai),Wn.connect(fr);const r=et.createBuffer(1,4*e,e),s=r.getChannelData(0);let a=0;for(let u=0;u<s.length;u++)a=(a+(Math.random()*2-1)*.02)/1.02,s[u]=a*3.5;const o=et.createBufferSource();o.buffer=r,o.loop=!0,ii=et.createBiquadFilter(),ii.type="lowpass",ii.frequency.value=180,Ii=et.createGain(),Ii.gain.value=0,o.connect(ii),ii.connect(Ii),Ii.connect(Wn),o.start(),Ii.gain.setTargetAtTime(ze.klang.raumton,hi(),.9);const l=et.createOscillator();l.frequency.value=.05;const c=et.createGain();c.gain.value=40,l.connect(c),c.connect(ii.frequency),l.start()}function v0(i){if(!$i)return;const e=i==="fotografie";ii.frequency.setTargetAtTime(e?140:180,hi(),.8),Ii.gain.setTargetAtTime(e?ze.klang.raumton*.7:ze.klang.raumton,hi(),.8)}function x0(i,e){if(!$i||vn)return;const t=hi(),n=1+(Math.random()-.5)*.16,r=ze.klang.schritt*(.6+.4*e)*n,s=et.createStereoPanner();s.pan.value=i?-.25:.25,s.connect(Wn);const a=et.createOscillator();a.frequency.setValueAtTime(78*n,t),a.frequency.exponentialRampToValueAtTime(40,t+.1);const o=et.createGain();o.gain.setValueAtTime(r*1.4,t),o.gain.exponentialRampToValueAtTime(.001,t+.12),a.connect(o),o.connect(s),a.start(t),a.stop(t+.14);const l=et.createBufferSource(),c=et.createBuffer(1,et.sampleRate*.06,et.sampleRate),u=c.getChannelData(0);for(let p=0;p<u.length;p++)u[p]=(Math.random()*2-1)*(1-p/u.length);l.buffer=c;const h=et.createBiquadFilter();h.type="bandpass",h.frequency.value=900+Math.random()*600,h.Q.value=1.2;const f=et.createGain();f.gain.value=r*.5,l.connect(h),h.connect(f),f.connect(s),l.start(t)}function M0(){if(!$i||vn)return;const i=hi(),e=et.createBufferSource(),t=et.createBuffer(1,et.sampleRate*.45,et.sampleRate),n=t.getChannelData(0);for(let a=0;a<n.length;a++)n[a]=Math.random()*2-1;e.buffer=t;const r=et.createBiquadFilter();r.type="lowpass",r.frequency.setValueAtTime(400,i),r.frequency.linearRampToValueAtTime(900,i+.18),r.frequency.linearRampToValueAtTime(300,i+.4);const s=et.createGain();s.gain.setValueAtTime(0,i),s.gain.linearRampToValueAtTime(.04,i+.15),s.gain.linearRampToValueAtTime(0,i+.42),e.connect(r),r.connect(s),s.connect(Wn),e.start(i)}function S0(){if(!$i||vn)return;const i=hi();for(const[e,t]of[[1318.5,0],[1975.5,.06]]){const n=et.createOscillator();n.frequency.value=e;const r=et.createGain();r.gain.setValueAtTime(0,i+t),r.gain.linearRampToValueAtTime(.05,i+t+.015),r.gain.exponentialRampToValueAtTime(5e-4,i+t+.6),n.connect(r),r.connect(fr),r.connect(Wn),n.start(i+t),n.stop(i+t+.65)}}function na(i,{peek:e=.46,voll:t=.88,onClose:n}={}){const r=i.querySelector(".sheet-handle");let s=0,a=null,o=0,l=0,c=null,u=0,h=0,f=0;const p=()=>window.innerHeight,_=()=>i.offsetHeight||p(),v=()=>Math.min(p()*t,_()),m=()=>{i.style.transform=`translateY(${_()-s}px)`};function d(M="peek"){return os()?(a=M,s=Math.min(Math.round(p()*(M==="voll"?t:e)),v()),i.classList.add("open"),m(),!0):!1}function w(){s=0,a=null,i.style.transform="",i.classList.remove("open")}r.addEventListener("pointerdown",M=>{os()&&(c=M.pointerId,o=u=M.clientY,h=performance.now(),l=s,f=0,i.classList.add("dragging"),r.setPointerCapture(c))}),r.addEventListener("pointermove",M=>{if(M.pointerId!==c)return;const D=performance.now();f=(M.clientY-u)/Math.max(1,D-h),u=M.clientY,h=D,s=Math.max(0,Math.min(v(),l-(M.clientY-o))),m()});function E(M){if(M.pointerId!==c)return;c=null,i.classList.remove("dragging");const D=p()*e,A=p()*t;let R;f>.55?R=s>D*1.15?"peek":"zu":f<-.55?R="voll":s<D*.55?R="zu":R=s>(D+A)/2?"voll":"peek",R==="zu"?(w(),n&&n()):d(R)}return r.addEventListener("pointerup",E),r.addEventListener("pointercancel",E),window.addEventListener("resize",()=>{if(i.classList.contains("open")){if(!os()){i.style.transform="",s=0,a=null;return}d(a||"peek")}}),{oeffne:d,schliesse:w}}const Xl="galerie-jp-sammlung",$a="galerie-jp-verkauft";function Bc(){try{return JSON.parse(localStorage.getItem($a))||[]}catch{return[]}}function E0({aktualisiereVerkauft:i,steuerungRef:e}){const t=G=>document.getElementById(G);let n=[];try{n=(JSON.parse(localStorage.getItem(Xl))||[]).filter(G=>Kt(G)&&!Kt(G).verkauft)}catch{n=[]}let r=null,s=null;function a(){const G=document.activeElement;s=G&&!G.closest(".panel")&&G!==document.body?G:null}function o(){s&&s.isConnected&&s.offsetParent!==null&&s.focus({preventScroll:!0}),s=null}function l(G){t("sr-status").textContent=G}const c=document.createElement("div");c.id="hover-label",document.body.appendChild(c);function u(G,ne,H){if(!G){c.classList.remove("visible");return}const W=Kt(G);c.innerHTML=`${W.titel}<span class="hl-price">${W.verkauft?"VERKAUFT":un(W.preis)}</span>`+(kt?'<span class="hl-tipp">Antippen für Details</span>':""),kt||(c.style.left=`${ne}px`,c.style.top=`${H}px`),c.classList.add("visible")}function h(){const G=t("intro");G.classList.add("leaving"),setTimeout(()=>G.remove(),1200),document.getElementById("scene").classList.add("walk")}function f(G){G==="top"&&t("chrome-top").classList.add("sichtbar"),G==="nav"&&t("room-nav").classList.add("sichtbar")}const p=t("fade"),_=t("saal-caption");let v=null;function m(G){_.querySelector(".sc-saal").textContent=G.saal,_.querySelector(".sc-name").textContent=G.name,_.querySelector(".sc-desc").textContent=G.beschreibung||"",_.classList.add("sichtbar"),clearTimeout(v),v=setTimeout(()=>_.classList.remove("sichtbar"),2400)}function d(G,ne){p.classList.add("dunkel"),setTimeout(()=>{ne(),m(G),p.classList.remove("dunkel")},380)}const w=document.createElement("div");w.id="sheet-backdrop",document.body.appendChild(w),w.addEventListener("click",()=>Y());const E=t("mute");function M(){E.textContent=Wl()?"🔇":"🔊",E.setAttribute("aria-label",Wl()?"Ton einschalten":"Ton ausschalten")}E.addEventListener("click",()=>{g0(),M()}),M();const D=t("room-nav");ht.forEach((G,ne)=>{const H=document.createElement("button");H.textContent=G.name,H.title=G.beschreibung||"";const W=document.createElement("span");W.className="nav-count",H.appendChild(W),H.addEventListener("click",()=>e().zuRaum(ne)),D.appendChild(H)});function A(){ht.forEach((G,ne)=>{const H=ls(G.id).filter(W=>!W.verkauft).length;D.children[ne].querySelector(".nav-count").textContent=H})}A();function R(G){[...D.children].forEach((ne,H)=>{ne.classList.toggle("active",H===G),H===G&&kt&&ne.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})})}const P=t("artwork-panel"),y=na(P,{peek:.58,onClose:()=>B()});function x(G){const ne=Kt(G);if(!ne)return;const H=!P.classList.contains("open");r=G;const W=zg(ne.raum);t("aw-room").textContent=`${W.saal} — ${W.name}`,t("aw-title").textContent=ne.titel,t("aw-artist").textContent=`${ne.kuenstler}`,t("aw-technique").textContent=ne.technik,t("aw-dimensions").textContent=`${ne.breite_cm} × ${ne.hoehe_cm} cm`,t("aw-year").textContent=ne.jahr,t("aw-desc").textContent=ne.beschreibung,t("aw-price").textContent=un(ne.preis),Qs(t("aw-bild"),ne),t("aw-bild").alt=`${ne.titel}, ${ne.kuenstler}`;const T=t("aw-inquiry");Zt.email?(T.classList.remove("hidden"),T.href=`mailto:${Zt.email}?subject=${encodeURIComponent(`Anfrage: ${ne.titel} — ${ne.kuenstler}`)}`):T.classList.add("hidden"),history.replaceState(null,"",`#${G}`),z(),y.oeffne("peek")||P.classList.add("open"),P.setAttribute("aria-hidden","false"),e().setzeSheetOffset(!0),H&&(a(),P.querySelector(".panel-close").focus({preventScroll:!0}))}function C(G){if(!r)return;const ne=Kt(r),H=ls(ne.raum),W=H.findIndex(Re=>Re.id===r),T=H[(W+G+H.length)%H.length];T&&T.id!==r&&(e().fokussiere(T.id)||x(T.id))}t("aw-prev").addEventListener("click",()=>C(-1)),t("aw-next").addEventListener("click",()=>C(1)),t("aw-share").addEventListener("click",async()=>{if(!r)return;const G=`${location.origin}${location.pathname}#${r}`;try{await navigator.clipboard.writeText(G),t("aw-share").textContent="Kopiert ✓",setTimeout(()=>t("aw-share").textContent="Link kopieren",1800)}catch{prompt("Link zum Werk:",G)}});function z(){if(!r)return;const G=Kt(r),ne=t("aw-add"),H=P.querySelector(".aw-buy");if(G.verkauft)H.classList.add("hidden"),t("aw-sold").classList.remove("hidden");else{H.classList.remove("hidden"),t("aw-sold").classList.add("hidden");const T=n.includes(G.id);ne.disabled=!1,ne.textContent=T?"Aus der Sammlung entfernen":"In die Sammlung",ne.classList.toggle("entfernen",T),ne.classList.toggle("hidden",G.preis==null)}const W=t("aw-stripe");G.stripeLink&&!G.verkauft?(W.classList.remove("hidden"),W.onclick=()=>window.open(G.stripeLink,"_blank","noopener")):W.classList.add("hidden")}t("aw-add").addEventListener("click",()=>{if(!r)return;const G=Kt(r);if(!G.verkauft){if(n.includes(G.id)){n=n.filter(ne=>ne!==G.id),re(),z(),ae(),l(`„${G.titel}" aus der Sammlung entfernt.`);return}n.push(G.id),re(),z(),ae(!0),S0(),l(`„${G.titel}" in die Sammlung gelegt.`)}});function B(){r=null,y.schliesse(),P.classList.remove("open"),P.setAttribute("aria-hidden","true"),e().fokusVerlassen(),e().setzeSheetOffset(!1),history.replaceState(null,"",location.pathname+location.search),o()}const q=t("cart-panel"),Z=na(q,{peek:.6,onClose:()=>Y()});function Y(){Z.schliesse(),q.classList.remove("open"),q.setAttribute("aria-hidden","true"),w.classList.remove("visible")}function re(){localStorage.setItem(Xl,JSON.stringify(n))}function K(){return n.reduce((G,ne)=>G+Kt(ne).preis,0)}function ae(G=!1){const ne=t("cart-count");ne.textContent=n.length,G&&(ne.classList.remove("bump"),ne.offsetWidth,ne.classList.add("bump"));const H=t("cart-items");if(H.innerHTML="",!n.length){const W=document.createElement("p");W.className="cart-empty",W.textContent="Noch keine Werke ausgewählt.",H.appendChild(W);const T=document.createElement("button");T.className="btn-stripe",T.textContent="Alle Werke ansehen",T.addEventListener("click",()=>{Y(),t("catalog-open").click()}),H.appendChild(T)}n.forEach(W=>{const T=Kt(W),Re=document.createElement("div");Re.className="cart-item";const ve=document.createElement("img");Qs(ve,T),ve.alt=T.titel,ve.addEventListener("click",()=>{Y(),e().fokussiere(W)||x(W)});const me=document.createElement("div");me.innerHTML=`<div class="cart-item-title">${T.titel}</div><div class="cart-item-artist">${T.kuenstler}, Unikat</div>`;const Q=document.createElement("div");Q.innerHTML=`<div class="cart-item-price">${un(T.preis)}</div>`;const Oe=document.createElement("button");Oe.className="cart-item-remove",Oe.textContent="Entfernen",Oe.addEventListener("click",()=>{n=n.filter(we=>we!==W),re(),ae(),z()}),Q.appendChild(Oe),Re.append(ve,me,Q),H.appendChild(Re)}),t("cart-total").textContent=un(K()),t("checkout-open").disabled=!n.length}const he=t("catalog-panel"),Pe=na(he,{peek:.88,onClose:()=>Ke()});function Ve(){const G=t("catalog-grid");G.innerHTML="",ht.forEach(ne=>{const H=document.createElement("p");H.className="catalog-saal eyebrow",H.textContent=`${ne.saal} — ${ne.name}`,G.appendChild(H),ls(ne.id).forEach(W=>{const T=document.createElement("button");T.className="catalog-item",T.innerHTML=`
          <img alt="" />
          <div class="ci-text">
            <div class="ci-titel">${W.titel}</div>
            <div class="ci-sub">${W.kuenstler} · ${ne.name}</div>
            <div class="ci-preis ${W.verkauft?"verkauft":""}">${W.verkauft?"Verkauft":un(W.preis)}</div>
          </div>`,Qs(T.querySelector("img"),W),T.addEventListener("click",()=>{Ke(),e().fokussiere(W.id)||x(W.id)}),G.appendChild(T)})})}function Ke(){Pe.schliesse(),he.classList.remove("open"),he.setAttribute("aria-hidden","true"),o()}t("catalog-open").addEventListener("click",()=>{P.classList.contains("open")&&B(),Ve(),Pe.oeffne("voll")||he.classList.add("open"),he.setAttribute("aria-hidden","false"),a(),he.querySelector(".panel-close").focus({preventScroll:!0})});const j=t("legal"),ce={impressum:{titel:"Impressum",text:`Angaben gemäß § 5 DDG.
